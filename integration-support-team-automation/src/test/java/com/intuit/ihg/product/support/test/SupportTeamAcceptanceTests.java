...
public class SupportTeamAcceptanceTests extends BaseTestNGWebDriver {
	 ...
	 * @StepsToReproduce: Description : Send communication to patients with corresponding attachments. Environment : PROD
	 *                    =============================================================
	 * @throws Exception =============================================================
	 */
	...
	public void testSendCommunicationsWithAttachment(int memberID, int practiceID, int staffID, String subject, String message) throws Exception {
		...
		try {
			...
			commCrit[2] = new Criteria(WebServiceConstants.FIELD_COMMDETAIL_STAFFID, WebServiceConstants.OPERATION_EQUALS, new Integer(staffID));
			commCrit[2] = new Criteria(WebServiceConstants.FIELD_COMMDETAIL_STAFFID, WebServiceConstants.OPERATION_EQUALS, new Integer(staffID));
			...
			fieldVector.add(new net.medfusion.integrations.webservices.medfusion.objects.Field(WebServiceConstants.FIELD_COMM_MEMBERID, new Integer(memberID)));
			fieldVector.add(new net.medfusion.integrations.webservices.medfusion.objects.Field(WebServiceConstants.FIELD_COMM_PRACTICEID, new Integer(practiceID)));

			fieldVector.add(new net.medfusion.integrations.webservices.medfusion.objects.Field(WebServiceConstants.FIELD_COMM_SUBJECT, subject));
			fieldVector.add(new net.medfusion.integrations.webservices.medfusion.objects.Field(WebServiceConstants.FIELD_COMM_MESSAGE, subject));
			...
			fieldVector.add(new net.medfusion.integrations.webservices.medfusion.objects.Field(WebServiceConstants.FIELD_COMM_CONTAINERID, -1));
			...
			detailFieldVector
					.add(new net.medfusion.integrations.webservices.medfusion.objects.Field(WebServiceConstants.FIELD_COMMDETAIL_STAFFID, new Integer(staffID)));
			...
			detailFieldVector
					.add(new net.medfusion.integrations.webservices.medfusion.objects.Field(WebServiceConstants.FIELD_COMMDETAIL_MEMBERID, new Integer(memberID)));
			...
			if (testFile.exists()) {
				...
				attachmentFieldVector
						.add(new net.medfusion.integrations.webservices.medfusion.objects.Field(WebServiceConstants.FIELD_COMMATTACHMENT_NAME, "MRI Attachment.pdf"));
	...
	/**
	 * @author bbinisha Description : Post ccd for patients with patient id 8527925, 8528000 and 3104305.
	 * @Date : 11-Nov-2013
	 * @User Story ID in Rally : US6870 Environment : PROD Note :- In order to send to more patients with same practice id and staff id, should update the
	 *       DataProvider with the details. ===============================================================================
	 * @throws Exception ===============================================================================
	 */
	 ...
	 * @Date :11-Nov-2013
	 * @User Story : US6870
	 * @Steps to reproduce Description : Sending Lab results for 3 Patients Environment : PROD =====================================================
	 * @throws Exception =====================================================
	 */
	...
	public void testLabResultForPatient(int memberID, int practiceID, int staffID, String subject, String message) throws Exception {
		...
		try {
			...
			fieldVector.add(new net.medfusion.integrations.webservices.medfusion.objects.Field(WebServiceConstants.FIELD_COMM_MESSAGE, inputXml));
			fieldVector.add(new net.medfusion.integrations.webservices.medfusion.objects.Field(WebServiceConstants.FIELD_COMM_SERVICETYPE,
