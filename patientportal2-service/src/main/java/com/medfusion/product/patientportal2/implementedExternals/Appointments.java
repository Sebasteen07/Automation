...
public class Appointments implements IAppointments {
		...
		@Override
		public List<Appointment> getAllAppointmentsForPatient(WebDriver driver, PortalBasic portal, PatientInfo patientInfo) throws ParseException {
		...
		@Override
		public List<Appointment> getUpcomingAppointmentsForPatient(WebDriver driver, PortalBasic portal, PatientInfo patientInfo) throws ParseException {
				JalapenoAppointmentsPage appointmentsPage = logInAndGoToAppointmentsPage(driver, portal.url, patientInfo.username, patientInfo.password);
		...
		@Override
		public List<Appointment> getPastAppointmentsForPatient(WebDriver driver, PortalBasic portal, PatientInfo patientInfo) throws ParseException {
				JalapenoAppointmentsPage appointmentsPage = logInAndGoToAppointmentsPage(driver, portal.url, patientInfo.username, patientInfo.password);
				appointmentsPage.goToPastAppointments();
