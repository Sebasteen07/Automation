...
public class JalapenoCreatePatientTest extends BaseTestNGWebDriver {
     ...
     * JalapenoCreateAccountPage2 jalapenoCreateAccountPage2 = jalapenoCreateAccountPage.fillInDataPage1(firstName,
     * lastName, email,
     ...
     * jalapenoCreateAccountPage2.fillInDataPage2(null, password, testData.getSecretQuestion(),
     * testData.getSecretAnswer(), testData.getphoneNumer());
