...
public class PayNow implements IPayNow {
	...
	@Override
	public String payNowWithRandomValues(WebDriver driver, Jalapeno portal) throws Exception {
		PayNowInfo payInfo = new PayNowInfo();
		return payNow(driver, portal, payInfo);
	}

	@Override
	public String payNow(WebDriver driver, Jalapeno portal, PayNowInfo payNowInfo) throws Exception {
