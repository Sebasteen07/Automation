...
public class SiteGenAcceptanceTests extends BaseTestNGWebDriver {
    ...
    public void testSiteGenLoginLogout() throws Exception {
        ...
        SiteGenHomePage pSiteGenHomePage = loginpage.login(testData.getAutomationUser(),
    ...
    public void testLocation() throws Exception {
        ...
        SiteGenPracticeHomePage pSiteGenPracticeHomePage = new SiteGenSteps().logInUserToSG(driver,
                testData.getAutomationUser(), testData.getAutomationUserPassword());
        ...
        // assertTrue(pManageYourLocationsPage.isSearchPageLoaded(), "Expected the SiteGen Manage location Page to be
        // loaded, but it was not.");
    ...
    public void testPermission() throws Exception {
        ...
        PracticeHomePage practiceHome = practiceLogin.login(testData.getpersonnelTypeUserName(),
                testData.getpersonnelTypePswd());
    ...
    public void testIntegrationEngAndInterfaceSetUp() throws Exception {
        ...
        assertTrue(verifyTextPresent(driver,
                "Integration '" + SitegenConstants.INTEGRATION_NAME + "' updated successfully."));
    ...
    public void testMerchantAccountSetUpViaPaypal() throws Exception {
        ...
        SiteGenPracticeHomePage practiseHome = new SiteGenSteps().logInUserToSG(driver,
                testCaseData.getAutomationUser(), testCaseData.getAutomationUserPassword());
    ...
    public void testImportAndExportStaff() throws Exception {
        ...
        assertTrue(verifyTextPresent(driver, "Import/Export Progress"),
    ...
    public void testMerchantAccountSetUpViaQBMS() throws Exception {
        ...
        assertTrue(pSiteGenHomePage.isSearchPageLoaded(),
                "Expected the SiteGen HomePage  to be loaded, but it was not.");
        log("step 3: navigate to SiteGen PracticeHomePage ##########");
        SiteGenPracticeHomePage practiceHome = pSiteGenHomePage
                .searchPracticeFromSGAdmin(testData.getAutomationPracticeName());
