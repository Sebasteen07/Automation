...
public class SiteGenAcceptanceTests extends BaseTestNGWebDriver {
	...
	private void testPhysicianBoth(boolean su) throws Exception {
		...
		if (su) {
			...
			pSiteGenHomePage = loginpage.login(testData.getProperty("automationUser"),
					testData.getProperty("automationPassword"));
			logStep("navigate to SiteGen PracticeHomePage");
	...
	public void testPermission() throws Exception {
		...
		PracticeLoginPage practiceLogin = new PracticeLoginPage(driver,
				testData.getProperty("siteGenAutomationPracticeUrl"));
		PracticeHomePage practiceHome = practiceLogin.login(testData.getProperty("personnelTypeUserName"),
				testData.getProperty("personnelTypePswd"));
	...
	public void testIntegrationEngAndInterfaceSetUp() throws Exception {
		logStep("LogIn");
		SiteGenLoginPage loginpage = new SiteGenLoginPage(driver, testData.getProperty("sitegenUrl"));
		SiteGenHomePage p1SiteGenHomePage = loginpage.login(testData.getProperty("automationUser"),
				testData.getProperty("automationPassword"));
		logStep("Navigate to SiteGen PracticeHomePage");
	...
	public void testMerchantAccountSetUpViaQBMS() throws Exception {
		...
		SiteGenHomePage pSiteGenHomePage = new SiteGenLoginPage(driver, testData.getProperty("sitegenUrl"))
				.clickOnLoginAsInternalEmployee();
		assertTrue(pSiteGenHomePage.isSearchPageLoaded(),
				"Expected the SiteGen HomePage  to be loaded, but it was not.");
		logStep("Navigate to SiteGen PracticeHomePage");
		SiteGenPracticeHomePage pSiteGenPracticeHomePage = pSiteGenHomePage
				.searchPracticeFromSGAdmin(testData.getProperty("siteGenAutomationPractice"));
