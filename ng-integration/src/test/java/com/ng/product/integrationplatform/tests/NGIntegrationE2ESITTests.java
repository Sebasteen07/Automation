...
//		assertTrue(completed, "Message processing was not completed in time");
		...
		log("Step End: Enrollment status is "+enrollment_status);
  		...
  		Mailinator mail = new Mailinator();
			Thread.sleep(15000);
			Log4jUtil.log(createPatient.getEmailAddress() + "   :    " + JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE + "     :   " + JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT);
			Thread.sleep(60000);
...
//        log("Result: RSDK sent the enrollemnt status to MF agent "+externalid+" person is added to person table in MF agent DB");
	...
	verifyProcessingStatusto3WithoutValidatingGetProcessingStatusCall(dependentperson_id.trim(),PropertyLoaderObj.getProperty("NGEnterprise1Practice1"),PropertyLoaderObj.getProperty("integrationPracticeIDE1P1"));
		...
		Log4jUtil.log(createPatient.getEmailAddress() + "   :    " + JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE + "     :   " + JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT);
		Thread.sleep(60000);
		String activationGuardianUrl = mail.getLinkFromEmail(createPatient.getEmailAddress(), JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE, JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT, 80);
		log("Step End: Guradian mail is received");
		
		log("Step 7: Verify the dependent mail");
		Log4jUtil.log(createdependent.getEmailAddress() + "   :    " + NewDependentActivationMessage + "     :   " + JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT);
		Thread.sleep(60000);
		String activationDependentUrl = mail.getLinkFromEmail(createdependent.getEmailAddress(), NewDependentActivationMessage, JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT, 80);
...
//		assertTrue(completed, "Message processing was not completed in time");
	...
	public void testBELEAutoPatientEnrollmentP1() throws Throwable{
		...
		log(createPatient.getEmailAddress() + "   :    " + INVITE_EMAIL_SUBJECT_PATIENT + PropertyLoaderObj.getProperty("practiceName1") + "     :   " + JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT);
		Thread.sleep(60000);	
	    ...
	    String activationUrlP1 = new Mailinator().getLinkFromEmail(createPatient.getEmailAddress(),
	                INVITE_EMAIL_SUBJECT_PATIENT + PropertyLoaderObj.getProperty("practiceName1"), JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT, 40);
	...
	public void testBELEPatientEnrollmentPracticeLevelE1P4() throws Throwable {
		...
		verifyProcessingStatusto3WithoutValidatingGetProcessingStatusCall(personId,PropertyLoaderObj.getNGEnterpiseEnrollmentE1P4(),PropertyLoaderObj.getProperty("integrationPracticeIDE1P4"));
  		...
  		Mailinator mail = new Mailinator();
			Thread.sleep(15000);
			log(createPatient.getEmailAddress() + "   :    " + INVITE_EMAIL_SUBJECT_PATIENT + PropertyLoaderObj.getProperty("practiceName4") + "     :   " + JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT);
			Thread.sleep(60000);	
			logStep("Logging into Mailinator and getting Patient Activation url for first Practice");
	        String activationUrl = mail.getLinkFromEmail(createPatient.getEmailAddress(),
	                INVITE_EMAIL_SUBJECT_PATIENT + PropertyLoaderObj.getProperty("practiceName4"), JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT, 80);
	        assertNotNull(activationUrl, "Error: Activation link not found.");
...
//        VerifyGetPIDCCall(timestamp, person_nbr,createPatient.getFirstName(), createPatient.getLastName(),"DEACTIVATED", PropertyLoaderObj.getProperty("integrationPracticeIDE1P2"));
	...
	public void testBELEPatientStatusE2P1EnrolledinE1P1() throws Throwable{
		...
		verifyProcessingStatusto3WithoutValidatingGetProcessingStatusCall(personId,PropertyLoaderObj.getNGEnterpiseEnrollmentE2P1(),PropertyLoaderObj.getProperty("integrationPracticeIDE2P1"));
  		...
  		Mailinator mail = new Mailinator();
			Thread.sleep(15000);
			log(createPatient.getEmailAddress() + "   :    " + INVITE_EMAIL_SUBJECT_PATIENT + PropertyLoaderObj.getProperty("E2practiceName1") + "     :   " + JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT);
			Thread.sleep(60000);	
			logStep("Logging into Mailinator and getting Patient Activation url for first Practice");
	        String activationUrl = mail.getLinkFromEmail(createPatient.getEmailAddress(),
	                INVITE_EMAIL_SUBJECT_PATIENT + PropertyLoaderObj.getProperty("E2practiceName1"), JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT, 80);
	        assertNotNull(activationUrl, "Error: Activation link not found.");
...
//        VerifyGetPIDCCall(timestamp, person_nbr,createPatient.getFirstName(), createPatient.getLastName(),"Registered", PropertyLoaderObj.getProperty("integrationPracticeIDE2P1"));
	...
	NGAPIFlows.addCharttoProvider(PropertyLoaderObj.getNGE1P3Location(),PropertyLoaderObj.getNGE1P3Provider(),dependentperson_id); 
		...
		Thread.sleep(15000);
		Log4jUtil.log(createPatient.getEmailAddress() + "   :    " + INVITE_EMAIL_SUBJECT_PATIENT + PropertyLoaderObj.getProperty("practiceName1") + "     :   " + JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT);
		Thread.sleep(60000);
		String activationGuardianUrl = mail.getLinkFromEmail(createPatient.getEmailAddress(), INVITE_EMAIL_SUBJECT_PATIENT + PropertyLoaderObj.getProperty("practiceName1"), JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT, 80);
		...
		Log4jUtil.log(createdependent.getEmailAddress() + "   :    " + NewDependentActivationMessage + PropertyLoaderObj.getProperty("practiceName1")+ "     :   " + JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT);
		Thread.sleep(60000);
		String activationDependentUrl = mail.getLinkFromEmail(createdependent.getEmailAddress(), NewDependentActivationMessage + PropertyLoaderObj.getProperty("practiceName1"), JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT, 80);
	...
	public String enrollPatientWithoutGetProcessingStatusValidation(NewPatient createPatient,String person_id,String practiceName,String integrationID, String enterprise_id,String practice_id) throws Throwable{
		...
		log("Step End: Patient enrollment status is "+CommonUtils.getResponseKeyValue(GetEnrollmentStatusresponse,"statusDescription"));
     	...
     	verifyProcessingStatusto3WithoutValidatingGetProcessingStatusCall(person_id,practice_id,integrationID);
  		...
  		Mailinator mail = new Mailinator();
			Thread.sleep(15000);
			log(createPatient.getEmailAddress() + "   :    " + INVITE_EMAIL_SUBJECT_PATIENT + practiceName + "     :   " + JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT);
			Thread.sleep(60000);
			logStep("Logging into Mailinator and getting Patient Activation url for first Practice");
	        String activationUrl = mail.getLinkFromEmail(createPatient.getEmailAddress(),
	                INVITE_EMAIL_SUBJECT_PATIENT + practiceName, JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT, 80);
	        assertNotNull(activationUrl, "Error: Activation link not found.");
...
//				Long timestamp = System.currentTimeMillis();
	...
	public void testPP139SendEHRImageWhileReplyingMessage() throws Throwable{
		...
		String peImageId = DBUtils.executeQueryOnDB("NGCoreDB","select top 1 image_id from patient_images where practice_id ='"+practiceId+"' and person_id ='"+person_id+"'");
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway",enterpriseId, practiceId);
    	String comm_id =NGAPIFlows.postSecureMessage(PropertyLoaderObj,"ReplyToPortal"+messageID,person_id,practiceId,userId,providerName,locationName, "EHR", "DoNotAddToEncounter","PracticeUser","","PatientImage",peImageId);		
    	...
    	String attachmentName =DBUtils.executeQueryOnDB("NGCoreDB","select orig_image_file from patient_images where image_id ='"+peImageId+"'");		
    	logStep("Setup Oauth client" + PropertyLoaderObj.getResponsePath());
    	if(PropertyLoaderObj.getNGAPIexecutionMode().equalsIgnoreCase("QAMain")){
    		RestUtils.oauthSetup(PropertyLoaderObj.getOAuthKeyStore(), PropertyLoaderObj.getOAuthProperty(), PropertyLoaderObj.getOAuthAppToken(), PropertyLoaderObj.getProperty("oAuthUsername1"),PropertyLoaderObj.getProperty("oAuthPassword1"));
		}
	    ...
	    CommonFlows.verifyMessageINInbox(PropertyLoaderObj,driver,url,username,PropertyLoaderObj.getPassword(),subject,body,comm_id,messageIDAtMF,integrationPracticeID,"messageWithPE",attachmentName);
	...
	public void testPP139SendEHRImageByCommunication() throws Throwable{
        ...
        NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway",enterpriseId,practiceId);    
    	String comm_id =NGAPIFlows.postSecureMessage(PropertyLoaderObj,"",person_id,practiceId,userId,providerName,locationName, "EPM", "DoNotAddToEncounter","PracticeUser","","PatientImage",peImageId);		
	...
	public void testPP139SendIMHByCommunication() throws Throwable{
        ...
        NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway",enterpriseId,practiceId);    
    	String comm_id =NGAPIFlows.postSecureMessage(PropertyLoaderObj,"",person_id,practiceId,userId,providerName,locationName, "EHR", "DoNotAddToEncounter","PracticeUser","","IMH",attachmentName);		
		...
		imhPage.fillIMH(driver, attachmentName,firstName,lastName,PropertyLoaderObj.getProperty("DOBMonth"),
				PropertyLoaderObj.getProperty("DOBDay"),PropertyLoaderObj.getProperty("DOBYear"),PropertyLoaderObj.getProperty("IMHForm"));
    ...
    public void testPP139SendIMH() throws Throwable {
        ...
        String firstName = DBUtils.executeQueryOnDB("NGCoreDB","select first_name from person where person_id = '"+person_id+"'");
    	String lastName = DBUtils.executeQueryOnDB("NGCoreDB","select last_name from person where person_id = '"+person_id+"'");
        String enterpriseId = null, practiceId = null, integrationPracticeID= null, providerName=null, locationName=null, url =null;
        ...
        String nxPracticeId = DBUtils.executeQueryOnDB("NGCoreDB","select nx_practice_id from nxmd_practices where practice_id = '"+practiceId+"'");
        String providerId = DBUtils.executeQueryOnDB("NGCoreDB","select provider_id from provider_mstr where description = '"+providerName+"'");
        String locationId = DBUtils.executeQueryOnDB("NGCoreDB","select location_id from location_mstr where location_name = '"+locationName+"'");
        
        logStep("Inserting IMH Form into tables");
        DBUtils.executeQueryOnDB("NGCoreDB","INSERT INTO ngweb_imh_question_state(id, patient_id, nx_practice_id, practice_id, "
        		...
        		+"VALUES ('"+documentId+"', '"+person_id+"','"+nxPracticeId+"','"+practiceId+"','"+providerId+"','"+locationId+"','"+docName+"', "
        		+ "'1',Null,'N', '0' , getutcdate(), getutcdate(),Null, '0')");
