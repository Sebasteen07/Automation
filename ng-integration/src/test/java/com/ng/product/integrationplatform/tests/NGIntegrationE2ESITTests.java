...
import static com.ng.product.integrationplatform.flows.NGAPIFlows.*;
import static com.ng.product.integrationplatform.apiUtils.NGAPIUtils.*;
...
public class NGIntegrationE2ESITTests extends BaseTestNGWebDriver {
	...
	public void testAEnrollPatientWithOnlyMandatoryDemographicsToMFPortal() throws Throwable {
		...
		String person_id = setupNGHttpPostRequest("EnterpriseGateway", finalURL, requestbody, 201);
		...
		addCharttoProvider(locationName, providerName, person_id);
		...
		setupNGHttpPostRequest("EnterpriseGateway", postEnrollmentURL, "", 409);
		...
		String GetEnrollmentStatusresponse = setupNGHttpGetRequest("EnterpriseGateway", getEnrollmentURL, 200);
...
//        log("Result: RSDK sent the enrollemnt status to MF agent "+externalid+" person is added to person table in MF agent DB");
		...
		String getEnrollmentStatusresponse2 = setupNGHttpGetRequest("EnterpriseGateway", getEnrollmentURL, 200);
	...
	public void testAEnrollPatientWithoutMandatoryDemographicsToMFPortal() throws Throwable {
		...
		apiRoutes personURL = apiRoutes.valueOf("AddEnterprisePerson");
		String finalURL = EnterprisebaseURL + personURL.getRouteURL();
		setupNGHttpPostRequest("EnterpriseGateway", finalURL, requestbody, 400);
		...
		setupNGHttpPostRequest("EnterpriseGateway", finalURL,
	...
	public void testAEnrollPatientWithoutMandatoryDemographicsZipToMFPortal() throws Throwable {
		...
		String getEnrollmentURL = EnterprisebaseURL
				+ apiRoutes.valueOf("GetEnrollmentStatus").getRouteURL().replaceAll("personId", person_id);
		setupNGHttpGetRequest("EnterpriseGateway", getEnrollmentURL, 404);
		log("No Enrollment status found for the patient");
	}
	...
	public void testACreateDependentAndGuardian() throws Throwable {
		...
		addCharttoProvider(locationName, providerName, dependentperson_id);
		...
		verifyProcessingStatusto3WithoutValidatingGetProcessingStatusCall(person_id.trim(),
				PropertyLoaderObj.getProperty("NGEnterprise1Practice1"),
				PropertyLoaderObj.getProperty("integrationPracticeIDE1P1"));
		verifyProcessingStatusto3WithoutValidatingGetProcessingStatusCall(dependentperson_id.trim(),
				PropertyLoaderObj.getProperty("NGEnterprise1Practice1"),
				PropertyLoaderObj.getProperty("integrationPracticeIDE1P1"));
		...
		Log4jUtil.log(createdependent.getEmailAddress() + "   :    " + NewDependentActivationMessage + "     :   "
				+ JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT);
		Thread.sleep(60000);
		String activationDependentUrl = mail.getLinkFromEmail(createdependent.getEmailAddress(),
				NewDependentActivationMessage, JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT, 80);
		...
		VerifyGetPIDCCall(timestamp, dependentperson_nbr, createdependent.getFirstName(), createdependent.getLastName(),
				"Registered", PropertyLoaderObj.getProperty("integrationPracticeIDE1P1"));

		log("Step 15: Using mailinator Mailer to retrieve the latest emails for patient and guardian");
		Thread.sleep(15000);
		Log4jUtil.log(
				createPatient.getEmailAddress() + "   :    " + MemberConfirmationMessage + "     :   " + PortalURL);
		Thread.sleep(60000);
		String MemberConfirmationUrl = mail.getLinkFromEmail(createPatient.getEmailAddress(), MemberConfirmationMessage,
				PortalURL, 80);
	...
	public void testACreateGuardianAndDependentANDEnrollOnlyDependentToPortal() throws Throwable {
		...
		verifyProcessingStatusto3WithoutValidatingGetProcessingStatusCall(dependentperson_id.trim(),
				PropertyLoaderObj.getProperty("NGMainPracticeID"), PropertyLoaderObj.getIntegrationPracticeID());
		...
		VerifyGetPIDCCall(timestamp, dependentperson_nbr, createdependent.getFirstName(), createdependent.getLastName(),
				"Registered", PropertyLoaderObj.getIntegrationPracticeID());
	...
	public void testALACreateTrustedRepresentativeOnly() throws Throwable {
		...
		addCharttoProvider(locationName, providerName, trustedperson_id);
...
//		assertTrue(completed, "Message processing was not completed in time");
	...
	public void verifyMFJOBStatusWithoutValidatingGetProcessingStatusCall(String person_id, String integrationID)
			throws Throwable {
...
//		assertTrue(completed, "Message processing was not completed in time");
	...
	public void VerifyGetPIDCCall(Long timestamp, String person_nbr, String FName, String LName, String portalStatus,
			String integrationID) throws IOException, ParserConfigurationException, SAXException, InterruptedException {
	...
	public void verifyMFJOBStatus(String person_id, String integrationID) throws Throwable {
		...
		String processingUrl = PropertyLoaderObj.getProcessingURL().replaceAll("integrationID", integrationID)
				.replaceAll("jobID", jobID.toLowerCase());
		Boolean completed = PatientRegistrationUtils.checkMessageProcessingOntime(processingUrl,
				PropertyLoaderObj.getResponsePath());
		assertTrue(completed, "Message processing was not completed in time");
	...
	public void verifyProcessingStatusto3WithoutValidatingGetProcessingStatusCall(String person_id, String practice_id,
	...
	public void testBELEAutoPatientEnrollmentP2() throws Throwable {
		...
		String personId = createPatientinEPM(createPatient);
		addCharttoProvider(PropertyLoaderObj.getNGE1P1Location(), PropertyLoaderObj.getNGE1P1Provider(), personId);
		addEncounter(PropertyLoaderObj.getNGE1P1Location(), PropertyLoaderObj.getNGE1P1Provider(), personId);

		enrollPatientWithoutGetProcessingStatusValidation(createPatient, personId,
		...
		addCharttoProvider(PropertyLoaderObj.getNGE1P2Location(), PropertyLoaderObj.getNGE1P2Provider(), personId);
		addEncounter(PropertyLoaderObj.getNGE1P2Location(), PropertyLoaderObj.getNGE1P2Provider(), personId);
		...
		VerifyGetPIDCCall(timestamp, person_nbr, createPatient.getFirstName(), createPatient.getLastName(),
				"Registered", PropertyLoaderObj.getProperty("integrationPracticeIDE1P2"));
		verifyPatientEnrollmentStatus(personId, PropertyLoaderObj.getProperty("NGEnterprise1Practice2"),
				PropertyLoaderObj.getProperty("NGEnterpiseEnrollmentEnterprise1"));
	...
	public void testBELEAutoPatientEnrollmentP1() throws Throwable {
		...
		verifyProcessingStatusto3WithoutValidatingGetProcessingStatusCall(personId,
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1P1(),
				PropertyLoaderObj.getProperty("integrationPracticeIDE1P1"));
		...
		addCharttoProvider(PropertyLoaderObj.getNGE1P3Location(), PropertyLoaderObj.getNGE1P3Provider(), personId);
		...
		VerifyGetPIDCCall(timestamp, person_nbr, createPatient.getFirstName(), createPatient.getLastName(),
				"Registered", PropertyLoaderObj.getProperty("integrationPracticeIDE1P1"));
		verifyPatientEnrollmentStatus(personId, PropertyLoaderObj.getProperty("NGEnterprise1Practice1"),
				PropertyLoaderObj.getProperty("NGEnterpiseEnrollmentEnterprise1"));
	...
	public void testBELEDeleteP3AutoPatientEnrollmentP1() throws Throwable {
		...
		VerifyGetPIDCCall(timestamp, person_nbr, createPatient.getFirstName(), createPatient.getLastName(), "DELETED",
				PropertyLoaderObj.getProperty("integrationPracticeIDE1P3"));

		verifyPatientEnrollmentDeletedStatus(personId, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P3(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
		verifyPatientEnrollmentStatus(personId, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P1(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
	...
	public void testBELEDeactivateP3AutoPatientEnrollmentP1() throws Throwable {
		...
		RestUtils.oauthSetup(PropertyLoaderObj.getOAuthKeyStore(), PropertyLoaderObj.getOAuthProperty(),
				...
				PropertyLoaderObj.getProperty("oAuthPassword3"));
		VerifyGetPIDCCall(timestamp, person_nbr, createPatient.getFirstName(), createPatient.getLastName(),
				"DEACTIVATED", PropertyLoaderObj.getProperty("integrationPracticeIDE1P3"));

		verifyPatientEnrollmentDeactivatedStatus(personId, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P3(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
		verifyPatientEnrollmentStatus(personId, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P1(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
	}
	...
	public void testBELEPatientEnrollmentPracticeLevelE1P4() throws Throwable {
		...
		Instant testStart = Instant.now();
		addCharttoProvider(PropertyLoaderObj.getNGE1P4Location(), PropertyLoaderObj.getNGE1P4Provider(), personId);
		...
		// VerifyGetPIDCCall(timestamp, person_nbr,createPatient.getFirstName(),
		// createPatient.getLastName(),"Registered",
		// PropertyLoaderObj.getProperty("integrationPracticeIDE1P4"));
		verifyPatientEnrollmentStatus(personId, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P4(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
	...
	public void testBELEDeleteP2PatientEnrolledP1P2P3() throws Throwable {
		...
		verifyPatientEnrollmentDeletedStatus(personId, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P2(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
		verifyPatientEnrollmentStatus(personId, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P1(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
		verifyPatientEnrollmentStatus(personId, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P3(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
	...
	public void testBELEDeactivateP2PatientEnrolledP1P2P3() throws Throwable {
		...
		verifyPatientEnrollmentDeactivatedStatus(personId, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P2(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
		verifyPatientEnrollmentStatus(personId, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P1(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
		verifyPatientEnrollmentStatus(personId, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P3(),
	...
	public void testBELEPatientEnrollmentE1P1TrustedRepresentativeE1P4() throws Throwable {
		...
		NewPatient trustedPatient = NGPatient.patientUsingJSON(PropertyLoaderObj, "trustedPatient");
		String trustedperson_id = createPatientinEPM(trustedPatient);
		log("Step End: Person created with id " + trustedperson_id);
		addCharttoProvider(PropertyLoaderObj.getNGE1P4Location(), PropertyLoaderObj.getNGE1P4Provider(),
				trustedperson_id);
	...
	public void testBELEPatientEnrollmentE1P1TrustedRepresentativeE1P2() throws Throwable {
		...
		String trustedperson_id = createPatientinEPM(trustedPatient);
		log("Step End: Person created with id " + trustedperson_id);
		addCharttoProvider(PropertyLoaderObj.getNGE1P2Location(), PropertyLoaderObj.getNGE1P2Provider(),
				trustedperson_id);

		enrollPatientWithoutGetProcessingStatusValidation(trustedPatient, trustedperson_id,
				PropertyLoaderObj.getProperty("practiceName2"),
	...
	public void testBELEPatientEnrollmentE1P4TrustedRepresentativeE1P5() throws Throwable {
		...
		NewPatient createPatient = NGPatient.patientUsingJSON(PropertyLoaderObj, "complete");
		String personId = createPatientinEPM(createPatient);
		addCharttoProvider(PropertyLoaderObj.getNGE1P5Location(), PropertyLoaderObj.getNGE1P5Provider(), personId);

		enrollPatientWithoutGetProcessingStatusValidation(createPatient, personId,
				PropertyLoaderObj.getProperty("practiceName5"),
	...
	public void testBELEPatientStatusE2P1EnrolledinE1P1() throws Throwable {
		...
		Instant testStart = Instant.now();
		addCharttoProvider(PropertyLoaderObj.getNGE2P1Location(), PropertyLoaderObj.getNGE2P1Provider(), personId);
		...
		// createPatient.getLastName(),"Registered",
		// PropertyLoaderObj.getProperty("integrationPracticeIDE2P1"));
		verifyPatientEnrollmentStatus(personId, PropertyLoaderObj.getNGEnterpiseEnrollmentE2P1(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE2());
	...
	public void testBCreateDependentAndGuardianP1P2P3() throws Throwable {
		...
		NewPatient createPatient = NGPatient.patientUsingJSON(PropertyLoaderObj, "complete");
		System.setProperty("ParentEmailAddress", createPatient.getEmailAddress());
		String person_id = createPatientinEPM(createPatient);
		log("Step End: Guardian created with id " + person_id);
		addCharttoProvider(PropertyLoaderObj.getNGE1P1Location(), PropertyLoaderObj.getNGE1P1Provider(), person_id);

		logStep("Create the Dependent in NG EPM Practice 1");
		NewPatient createdependent = NGPatient.patientUsingJSON(PropertyLoaderObj, "Dependent");
		createdependent = NGPatient.addDataToPatientDemographics(PropertyLoaderObj, createdependent);
		String dependentperson_id = createPatientinEPM(createdependent);
		log("Step End: Dependent created with id " + dependentperson_id);
		addCharttoProvider(PropertyLoaderObj.getNGE1P1Location(), PropertyLoaderObj.getNGE1P1Provider(),
				dependentperson_id);
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", PropertyLoaderObj.getNGEnterpiseEnrollmentE1(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1P2());
		Instant testStart = Instant.now();
		addCharttoProvider(PropertyLoaderObj.getNGE1P2Location(), PropertyLoaderObj.getNGE1P2Provider(), person_id);
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", PropertyLoaderObj.getNGEnterpiseEnrollmentE1(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1P3());
		addCharttoProvider(PropertyLoaderObj.getNGE1P3Location(), PropertyLoaderObj.getNGE1P3Provider(), person_id);

		logStep("Create the Dependent chart in third practice");
		addCharttoProvider(PropertyLoaderObj.getNGE1P3Location(), PropertyLoaderObj.getNGE1P3Provider(),
				dependentperson_id);
		...
		Thread.sleep(60000);
		String activationDependentUrl = mail.getLinkFromEmail(createdependent.getEmailAddress(),
				NewDependentActivationMessage + PropertyLoaderObj.getProperty("practiceName1"),
				JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT, 80);
...
//		VerifyGetPIDCCall(timestamp, dependentperson_nbr,createdependent.getFirstName(), createdependent.getLastName(),"Registered");
		verifyPatientEnrollmentStatus(person_id, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P1(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
		verifyPatientEnrollmentStatus(dependentperson_id, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P1(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
		verifyPatientEnrollmentStatus(person_id, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P2(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
		verifyPatientEnrollmentStatus(dependentperson_id, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P2(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
		verifyPatientEnrollmentStatus(person_id, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P3(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
		verifyPatientEnrollmentStatus(dependentperson_id, PropertyLoaderObj.getNGEnterpiseEnrollmentE1P3(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1());
...
//			VerifyGetPIDCCall(timestamp, dependentperson_nbr,createdependent.getFirstName(), createdependent.getLastName(),"Registered");
	...
	public String enrollPatientWithoutGetProcessingStatusValidation(NewPatient createPatient, String person_id,
			String practiceName, String integrationID, String enterprise_id, String practice_id) throws Throwable {
		...
		Mailinator mail = new Mailinator();
		Thread.sleep(15000);
		log(createPatient.getEmailAddress() + "   :    " + INVITE_EMAIL_SUBJECT_PATIENT + practiceName + "     :   "
				+ JalapenoConstants.NEW_PATIENT_ACTIVATION_MESSAGE_LINK_TEXT);
		Thread.sleep(60000);
		logStep("Logging into Mailinator and getting Patient Activation url for first Practice");
		String activationUrl = mail.getLinkFromEmail(createPatient.getEmailAddress(),
	...
	public String enrollNGPatienttoMFPortal(NewPatient createPatient, String person_id, String practiceName,
			String integrationID) throws Throwable {
		Long timestamp1 = System.currentTimeMillis();
		logStep("Using Post Enrollment call, Verify the MF agent trigger for new patient");
		String PostEnrollmentURL = EnterprisebaseURL
		...
		String jobID = DBUtils.executeQueryOnDB("MFAgentDB",
				"select jobid from processingstatus where id = (select top 1 processingstatus_id from processingstatus_entity where entityidentifier ='"
						+ person_nbr.trim().replace("\t", "") + " order by createdts desc')");
	...
	public void verifyPatientEnrollmentStatus(String personId, String practice_id, String enterprise_id)
			throws Throwable {
		logStep("Find the patient and check if he is registered");
		String processing_status = DBUtils.executeQueryOnDB("NGCoreDB",
				"select processing_status from pxp_enrollments where person_id = '" + personId.trim()
	...
	public void verifyPatientEnrollmentDeletedStatus(String personId, String practice_id, String enterprise_id)
			throws Throwable {
		logStep("Verify the enrollment and processing status of patient in pxp enrollment table for practice_id "
				+ practice_id);
		String processing_status = DBUtils.executeQueryOnDB("NGCoreDB",
				"select processing_status from pxp_enrollments where person_id = '" + personId.trim()
						+ "' and practice_id='" + practice_id + "'");
	...
	public void verifyPatientEnrollmentDeactivatedStatus(String personId, String practice_id, String enterprise_id)
			throws Throwable {
		logStep("Verify the enrollment and processing status of patient in pxp enrollment table for practice_id "
				+ practice_id);
		String processing_status = DBUtils.executeQueryOnDB("NGCoreDB",
	...
	public void testCCDPracticeLevelEnrollmentOnDemandCCD() throws Throwable {
		...
		enrollPatientWithoutGetProcessingStatusValidation(createPatient, person_id,
				PropertyLoaderObj.getProperty("practiceName"), integrationPracticeId, enterpriseId, practiceId);
	...
	public void testCCDGuardianDependentCCD() throws Throwable {
		...
		addCharttoProvider(locName, provName, person_id);
		...
		addCharttoProvider(locName, provName, dependentperson_id);
...
//		CommonFlows.addDataToCCD(locationName, providerName, dependentperson_id, practiceId);
		...
		CommonFlows.verifyCCDProcessingStatus(PropertyLoaderObj, dependentperson_id,
				PropertyLoaderObj.getProperty("NGEnterprise1Practice1"),
				PropertyLoaderObj.getProperty("integrationPracticeIDE1P1"), 1);

		logStep("Verify Dependent is able to receive Enrollment CCD");
		CommonFlows.IsCCDReceived(driver, PropertyLoaderObj.getProperty("MFPortalURLPractice1"),
				createPatient.getEmailAddress(), PropertyLoaderObj.getPassword(), "Dependent", "");
		...
		CommonFlows.requestCCD(driver, PropertyLoaderObj.getProperty("MFPortalURLPractice1"),
				createPatient.getEmailAddress(), PropertyLoaderObj.getPassword(), "Dependent", "");
		...
		logStep("Do the Get onDemand Health Data Get API Call.");
		RestUtils.setupHttpGetRequest(
				PropertyLoaderObj.getProperty("GetHealthData").replaceAll("integrationID",
						PropertyLoaderObj.getProperty("integrationPracticeIDE1P1")) + "?since=" + since + ",0",
				PropertyLoaderObj.getResponsePath());
		...
		CommonFlows.verifyCCDProcessingStatus(PropertyLoaderObj, dependentperson_id,
				PropertyLoaderObj.getProperty("NGEnterprise1Practice1"),
				PropertyLoaderObj.getProperty("integrationPracticeIDE1P1"), 2);
...
//		String locationName1 = PropertyLoaderObj.getProperty("NGE1P1Location");
//		String providerName1 = PropertyLoaderObj.getProperty("NGE1P1Provider");
		String practiceId1 = PropertyLoaderObj.getProperty("NGEnterprise1Practice1");
		String integrationPracticeId1 = PropertyLoaderObj.getProperty("integrationPracticeIDE1P1");
...
//		CommonFlows.addDataToCCD(locationName1, providerName1, trustedperson_id, practiceId1);
		...
		CommonFlows.IsCCDReceived(driver, PropertyLoaderObj.getProperty("MFPortalURLPractice1"),
				trustedPatient.getEmailAddress(), PropertyLoaderObj.getPassword(), "", "");
		...
		logStep("Do the Get onDemand Health Data Get API Call.");
		RestUtils.setupHttpGetRequest(
				PropertyLoaderObj.getProperty("GetHealthData").replaceAll("integrationID", integrationPracticeId1)
						+ "?since=" + since1 + ",0",
				PropertyLoaderObj.getResponsePath());
	...
	public void testCCDMSUCCD() throws Throwable {
		...
		enrollPatientWithoutGetProcessingStatusValidation(createPatient, person_id, practiceName, integrationPracticeId,
				enterpriseId, practiceId);
		...
		String encounter_id = addEncounter(locationName, providerName, person_id);

		logStep("Request for MSU CCD");
		postCCDRequest(locationName, providerName, person_id, "MedicalSummaryUtility", encounter_id);
	...
	public void testCCDLockedEncounterCCD() throws Throwable {
		...
		addDiagnosis(practiceId, person_id, encounter_id);

		Log4jUtil.log("Step Begins: Add Medication to created encounter");
		addMedication(practiceId, locationName, providerName, "Active", person_id, encounter_id, "R07.9", 286939);

		Log4jUtil.log("Step Begins: Add allergy to created encounter");
		addAllergy(locationName, providerName, person_id, encounter_id, "1000", 2);

		Log4jUtil.log("Step Begins: Add Problem to patient chart");
		addProblem(locationName, providerName, person_id, "420543008", "55561003", "Active");

		Log4jUtil.log("Step Begins: Add Immunization to created encounter");
		addNewImmunizationsOrder(locationName, providerName, person_id, encounter_id);

		Log4jUtil.log("Step Begins: Add lab Order and lab results to patient CCD");
		String labOrder_id = addLabOrder(locationName, providerName, person_id, encounter_id);
//		String labOrderTest_id = addLabOrderTest(person_id, labOrder_id, "NG001032");
//		String ObsPanel_id = addObsPanel(person_id, labOrder_id);
//		String labResult_id = addLabResult(person_id, ObsPanel_id, "75325-1");
		updateLabOrder(locationName, providerName, person_id, labOrder_id);
		...
		postCCDRequest(locationName, providerName, person_id, "LockedEncounter", encounter_id);
	...
	public void testCCDUnSignedOffLabResultInCCD() throws Throwable {
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", PropertyLoaderObj.getNGEnterpiseEnrollmentE1(),
				PropertyLoaderObj.getNGEnterpiseEnrollmentE1P1());
		String person_id = createCommonPatient(PropertyLoaderObj, enterpriseID, practiceId, practiceName,
...
//		String labResult_id = addLabResult(person_id, ObsPanel_id, "75325-1");
	...
	public String createCommonPatient(PropertyFileLoader PropertyLoaderObj, String enterpriseID, String practiceID,
			String practiceName, String integrationPacticeID) throws NullPointerException, Throwable {
		...
		try {
			...
			enrollPatientWithoutGetProcessingStatusValidation(createPatient, person_id, practiceName,
					integrationPacticeID, enterpriseID, practiceID);
		} catch (Exception e) {
...
//		String labResult_id = addLabResult(person_id, ObsPanel_id, "75325-1");
		...
		updateToSensitiveEncounter(locationName, providerName, person_id, encounter_id);
...
//		String locationName = PropertyLoaderObj.getProperty("NGE1P2Location");
//		String providerName = PropertyLoaderObj.getProperty("NGE1P2Provider");
		String practiceId = PropertyLoaderObj.getProperty("NGEnterprise1Practice2");
		String integrationPracticeId = PropertyLoaderObj.getProperty("integrationPracticeIDE1P2");
...
//		CommonFlows.addDataToCCD(locationName1, providerName1, personId, practiceId1);
		...
		CommonFlows.IsCCDReceived(driver, PropertyLoaderObj.getProperty("MFPortalURLPractice1"),
				createPatient.getEmailAddress(), PropertyLoaderObj.getPassword(), "", "");
		...
		CommonFlows.IsCCDReceived(driver, PropertyLoaderObj.getProperty("MFPortalURLPractice2"),
				createPatient.getEmailAddress(), PropertyLoaderObj.getPassword(), "", "");

		logStep("Request OnDemand CCD for Practice 2");
		CommonFlows.requestCCD(driver, PropertyLoaderObj.getProperty("MFPortalURLPractice2"),
				createPatient.getEmailAddress(), PropertyLoaderObj.getPassword(), "", "");
		...
		CommonFlows.verifyCCDProcessingStatus(PropertyLoaderObj, trustedperson_id, practiceId, integrationPracticeId,
				1);
		...
		String trustedperson_nbr = DBUtils.executeQueryOnDB("NGCoreDB",
				"select person_nbr from person where person_id = '" + trustedperson_id + "'");

		logStep("Verify CCD received in the Get Api Call.");
		RestUtils.verifyOnDemandRequestSubmitted(PropertyLoaderObj.getResponsePath(),
				trustedperson_nbr.trim().replace("\t", ""));
	...
	public void testCOMHighPrioritySecureMessageDoNotAddToEncounterSendByPracticeUser() throws Throwable {
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		String comm_id = postSecureMessage(PropertyLoaderObj, "HighPriority", person_id, practiceId, userId,
	...
	public void testCOMReadReceiptSecureMessageNewLockedEncounter() throws Throwable {
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		String comm_id = postSecureMessage(PropertyLoaderObj, "ReadReceiptRequested", person_id, practiceId, userId,
				providerName, locationName, "EHR", "NewLockedEncounter", "PracticeUser", "", "", "");
	...
	public void testCOMUnreadNotificationSecureMessageNewUnLockedEncounter() throws Throwable {
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		postSecureMessage(PropertyLoaderObj, "UnreadNotificationRequested", person_id, practiceId, userId, providerName,
				locationName, "EHR", "NewUnLockedEncounter", "PracticeUser", "", "", "");
	...
	public void testCOMDisableReplySecureMessageExistingEncounter() throws Throwable {
		...
		String comm_id = postSecureMessage(PropertyLoaderObj, "DisableReply", person_id, practiceId, userId,
	...
	public void testCOMSecureMessageSentAndReplyUsingOnlineProfile() throws Throwable {
		...
		String comm_id = postSecureMessage(PropertyLoaderObj, "SentByOnlineProfile", person_id, practiceId, userId,
				providerName, locationName, "EHR", "DoNotAddToEncounter", "PracticeUser", "", "", "");
	...
	public void testCOMSecureMessageSentAndReplyUsingAliasName() throws Throwable {
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		String comm_id = postSecureMessage(PropertyLoaderObj, "ReplyToASKAUsingAliasName" + messageID, person_id,
	...
	public void testCOMAskAQuestionRepliedUsingOriginalUnlockedEncounter() throws Throwable {
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		String comm_id = postSecureMessage(PropertyLoaderObj, "ReplyToPortal" + messageID, person_id, practiceId,
				userId, providerName, locationName, "EHR", "OriginalUnlockedEncounter", "PracticeUser", "", "", "");
	...
	public void testCOMSendSecureMessageDoNotAddToChart() throws Throwable {
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		String comm_id = postSecureMessage(PropertyLoaderObj, "", person_id, practiceId, userId, providerName,
				locationName, "EHR", "DoNotAddToEncounter", "PracticeUser", "", "", "");
	...
	public void testInboxAppointment() throws Throwable {
		...
		if (deleteIND.equalsIgnoreCase("N")) {
			NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
			deleteAppointment(DBUtils.executeQueryOnDB("NGCoreDB", ApptIDQuery));
		}
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		String EPMAppointmenttId = postAppointment(person_id, practiceId, locationName, providerName, eventName,
				resourceName, 2, apptTime, 201);

		DBUtils.executeQueryOnDB("MFAgentDB", UpdateToEPMCategoryQuery);
		String appointmentResponse = "ApptResponse" + System.currentTimeMillis();
		logStep("Send appointment response to Patient");
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		postAppointmentResponse(appointmentID, EPMAppointmenttId, appointmentResponse, apptTime, 2);
...
//		appointmentDate = CommonUtils.changeESTtoIST(new SimpleDateFormat("M/d/yy hh:mm").format(date));
	...
	public void testInboxAppointmentSameSlot() throws Throwable {
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		postAppointment(person_id, practiceId, locationName, providerName, eventName, resourceName, 2, apptTime, 201);
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		postAppointment(person_id, practiceId, locationName, providerName, eventName, resourceName, 2, apptTime, 400);
...
//		appointmentDate = CommonUtils.changeESTtoIST(new SimpleDateFormat("M/d/yy hh:mm").format(date));
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		deleteAppointment(EPMAppointmenttId);
	...
	/************************
	 * 
	 * @author Raghavendra Gupta Test case: NEX-4374
	 * 
	 ************************/
	...
	public void testInboxMultiPracticeAppointmentBookWithExistingPatient() throws Throwable {
		...
		NGAppointmentRequestV2Step1 appointmentRequestStep3 = PageFactory.initElements(driver,
				NGAppointmentRequestV2Step1.class);
	...
	public void testInboxMultiPracticeAppointmentBookWithNewPatient() throws Throwable {
		...
		String practiceId = null, integrationPracticeID = null;
		...
		JalapenoHomePage homePage = accountDetailsPage.fillAccountDetailsAndContinue(createPatient.getEmailAddress(),
				PropertyLoaderObj.getPassword(), PropertyLoaderObj.getSecretQuestion(),
				PropertyLoaderObj.getSecretAnswer(), PropertyLoaderObj.getPhoneNumber());
	...
	public void testPP138SendPatientEducation() throws Throwable {
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		String comm_id = postSecureMessage(PropertyLoaderObj, "", person_id, practiceId, userId, providerName,
				locationName, "EHR", "DoNotAddToEncounter", "PracticeUser", "", "PatientEducation", PEdocumentId);
	...
	public void testInboxPrescription() throws Throwable {
		...
		Log4jUtil.log("Step Begins: Add Medication to created encounter");
		String medication_id = addMedication(practiceId, locationName, providerName, "Active", person_id, encounter_id,
				"R07.9", 286939);
	...
	public void testInboxRequestPrescriptionRenewalApprovedbyPracticeUser() throws Throwable {
		...
		putPrescriptionRenewalRequest(person_id, prescriptionID, prescritonRenewalResponse, "NewLockedEncounter",
				locationName, providerName, "Accepted", 200);
	...
	public void testInboxRequestPrescriptionRenewalRejectedbyPracticeUser() throws Throwable {
		...
		putPrescriptionRenewalRequest(person_id, prescriptionID, prescritonRenewalResponse, "NewLockedEncounter",
				locationName, providerName, "Rejected", 200);
	...
	public void testCOMBulkSendSecureMessageDoNotAddToEncounterSendByPracticeUser() throws Throwable {
		...
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		String comm_id = postBulkSecureMessage(PropertyLoaderObj, "Bulk1", personIdList, practiceId, userId,
				providerName, locationName, "EHR", "DoNotAddToEncounter", "PracticeUser", "", "", "");
	...
	public void testInboxAppointmentBookForDependentUsingExistingGuardianAccount() throws Throwable {
		...
		String dependent_person_id = DBUtils.executeQueryOnDB("NGCoreDB",
				"select person_id from person where email_address = '" + guardianEmail + "' and last_name='"
						+ dependentLastName + "'");
		logStep("Schedule an appointment for Patient");
		String apptTime = "05:30:00";
		NGAPIUtils.updateLoginDefaultTo("EnterpriseGateway", enterpriseId, practiceId);
		String EPMAppointmenttId = postAppointment(dependent_person_id, practiceId, locationName, providerName,
		...
		CommonFlows.verifyAppointmentReceivedinPortal(PropertyLoaderObj, driver, url, username,
				appointmentDate.substring(0, appointmentDate.lastIndexOf(" ")),
				appointmentDate.substring(appointmentDate.lastIndexOf(" ") + 1), appointmentResponse);
		Log4jUtil.log(
				"Test Case End: The patient is able to request for appointment and practice user is able to book appointment and send response to patient");
	}
	...
	public void testPaymentOnlineBillPayProcess() throws Throwable {
		...
		pPayMyBillOnlinePage.setTransactionsForOnlineBillPayProcess(PropertyLoaderObj.getProperty("PortalLocationName"),
				...
				PracticeConstants.PROCESS_CARD_HOLDER_NAME, PracticeConstants.CARD_NUM_MASTERCARD,
				PracticeConstants.CARD_TYPE_MASTERCARD, paymentComment);
		...
		CommonFlows.verifyPaymentReachedtoMFAgent(paymentComment, "BillPayment", "", accountNumber, "POSTED",
				actualAmount, PracticeConstants.CARD_TYPE_MASTERCARD);

		String SourceIdQuery = "select acct_id from accounts where guar_id ='" + person_id + "' and practice_id='"
				+ practiceId.trim() + "'";
		String SourceId = DBUtils.executeQueryOnDB("NGCoreDB", SourceIdQuery);
		CommonFlows.verifyPaymentPostedtoNG(paymentComment, SourceId, person_id, "-" + actualAmount,
				"Payment type: BillPayment, Last 4 CC digits: " + PracticeConstants.CARD_NUM_MASTERCARD.substring(12),
				practiceId);
	...
	public void testPaymentBudgetPaymentProcess() throws Throwable {
		...
		pPayMyBillOnlinePage.setTransactionsForBudgetPaymentPlan(PropertyLoaderObj.getProperty("PortalLocationName"),
				PropertyLoaderObj.getProperty("PortalProviderName").replaceAll(", Dr", ""), accountNumber, amount,
				prepayamount, PracticeConstants.PROCESS_CARD_HOLDER_NAME, PracticeConstants.CARD_NUM_MASTERCARD,
				PracticeConstants.CARD_TYPE_MASTERCARD);
		...
		assertTrue(pPayMyBillOnlinePage.getCreditCardLastFourDigits()
				.contains(PracticeConstants.CARD_NUM_MASTERCARD.substring(12)));
		...
		assertTrue(pPayMyBillOnlinePage.getActiveBudgetPaymentCardDigit()
				.contains(PracticeConstants.CARD_NUM_MASTERCARD.substring(12)));
	...
	public void testPaymentOnlineBillPayProcessforSingleGuarantor() throws Throwable {
		...
		pPayMyBillOnlinePage.setTransactionsForOnlineBillPayProcess(PropertyLoaderObj.getProperty("PortalLocationName"),
				...
				amount, PracticeConstants.PROCESS_CARD_HOLDER_NAME, PracticeConstants.CARD_NUM_MASTERCARD,
				PracticeConstants.CARD_TYPE_MASTERCARD, paymentComment);
		...
		CommonFlows.verifyPaymentReachedtoMFAgent(paymentComment, "BillPayment", personNumber.trim().replace("\t", ""),
				invalidAccountNumber, "POSTED", actualAmount, PracticeConstants.CARD_TYPE_MASTERCARD);
