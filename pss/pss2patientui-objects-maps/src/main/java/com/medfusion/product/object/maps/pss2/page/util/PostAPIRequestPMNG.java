...
public class PostAPIRequestPMNG extends BaseTestNGWebDriver {
	...
	public Response apptDetailFromGuid(String baseurl, Map<String, String> Header, String guidId,
			String practiceid) {
		RestAssured.baseURI = baseurl;
		Response response = given().log().all().headers(Header).when().get(practiceid+"/"+guidId + "/getapptdetails").then().log().all().extract()
				.response();
		return response;
	}
	...
	public Response practiceInfo(String baseurl, Map<String, String> Header, String PracticeId, String practiceName) {
		RestAssured.baseURI = baseurl;
		Response response = given().log().all().when().get(PracticeId + "/practice").then().log().all().extract().response();
		return response;
	}
	...
	public Response announcementByLanguage(String baseurl, Map<String, String> Header, String practiceId) {
		RestAssured.baseURI = baseurl;
		Response response = given().log().all().headers(Header).when().get(practiceId + "/announcementbylanguage").then().log().all()
				.extract().response();		
		return response;
	}
	...
	public Response getImages(String baseurl, Map<String, String> Header, String practiceId, String bookId) {
		RestAssured.baseURI = baseurl;
		Response response = given().log().all().when().get(practiceId + "/book/" + bookId + "/image").then().log().all().extract().response();		
		return response;
	}

	public Response getLanguages(String baseurl, Map<String, String> Header, String patientId) {
		RestAssured.baseURI = baseurl;
		Response response = given().log().all().when().get("/language/" + patientId).then().log().all().extract().response();
		return response;
	}

	public Response demographicsProfiles(String baseurl, Map<String, String> Header, String practiceId, String patientId) {
		RestAssured.baseURI = baseurl;
		Response response = given().log().all().headers(Header).when().get(practiceId + "/demographics/" + patientId).then().log().all()
				.extract().response();
		return response;
	}
	...
	public Response matchPatient(String baseurl, Map<String, String> Header, String practiceId, String patientId) {
		...
		Response response = given().log().all().headers(Header).log().all().when()
				.get(practiceId + "/patientmatch/LOGINLESS").then().log().all().assertThat()
				.statusCode(200).extract().response();
		return response;
	}
	...
	public Response genderMapping(String baseurl, Map<String, String> Header, String practiceId) {
		RestAssured.baseURI = baseurl;
		Response response = given().log().all().headers(Header).log().all().when()
				.get(practiceId + "/gendermapping").then().log().all()
				.extract().response();
		return response;
	}
	...
	public Response getStates(String baseurl, Map<String, String> Header, String practiceId) {
		RestAssured.baseURI = baseurl;
		Response response = given().log().all().headers(Header).log().all().when()
				.get(practiceId + "/states").then().log().all().extract().response();
		return response;
	}
	...
	public Response identifyPatientForReschedule(String baseurl, String b, Map<String, String> Header, String practiceId) {
		RestAssured.baseURI = baseurl;
		Response response = RestAssured.given().when().headers(Header).body(b).log().all().when()
				.post(practiceId + "/identifypatient").then().log().all().
				extract().response();
		return response;
	}
	...
	public Response specialtyByRule(String baseurl, String b, Map<String, String> Header, String practiceId,
		...
		RestAssured.baseURI = baseurl;
		Response response = RestAssured.given().when().headers(Header).body(b).log().all().when()
				.post(practiceId + "/specialty/rule/" + patientId).then().log().all()
				.extract().response();
		return response;
	}
	...
	public Response locationsBasedOnZipcodeAndRadius(String baseurl, String b, Map<String, String> Header,
		...
		RestAssured.baseURI = baseurl;
		Response response = RestAssured.given().when().headers(Header).body(b).log().all().when()
				.post(practiceId + "/zipcode/" + patientId).then().log().all().extract()
				.response();
		return response;
	}
	...
	public Response timeZoneCode(String baseurl, String b, Map<String, String> Header, String practiceId,
		...
		Response response = given().when().headers(Header).body(b).log().all().when()
				.post(practiceId + "/timezonecode/" + patientId).then().log().all()
				.extract().response();
		return response;
	}
	...
	public Response availableSlots(String baseurl, String b, Map<String, String> Header, String practiceId,
		...
		if(patientId== null) {
			response=given().when().headers(Header).body(b).log().all().when()
			 ...
			 response= given().when().headers(Header).body(b).log().all().when()
					.post(practiceId + "/availableslots/" + patientId).then().log().all()
					.extract().response();
		}		
	...
	public Response cancelAppointment(String baseurl, String b, Map<String, String> Header, String practiceId,
		...
		Response response = given().when().headers(Header).body(b).log().all().when()
				.post(practiceId + "/cancelappointment/" + patientId).then().log().all()
				.extract().response();
	...
	public Response scheduleAppointment(String baseurl, String b, Map<String, String> Header, String practiceId,
		...
		Response response = given().when().headers(Header).body(b).log().all().when()
				.post(practiceId + "/scheduleappointment/" + patientId).then().log().all()
				.extract().response();
