...
public class PortalAcceptanceTests extends BaseTestNGWebDriver {
    ...
    private void activatePatient(String unlockLink, String zip, String email, TestcasesData testcasesData)
            throws Exception {
        ...
        MyPatientPage pMyPatientPage = pCreateAccountPage.fillPatientActivaion(zip, email, testcasesData.getPassword(),
    ...
    public void testVirtualOfficeVisitEnd2End() throws Exception {
        ...
        AskAStaffQuestionDetailStep3Page vovConfirm = vovPrescribe.prescribeAndCommunicate(PortalConstants.Subject,
                "Body");
        ...
        assertTrue(verifyTextPresent(driver,
                "Your prescription and communication have been posted and the visit has been closed."));
    ...
    public void testAddNewPatientSearch() throws Exception {
        ...
        activatePatient(patientActivationTest.getUnlockLink(), patientActivationTest.getZipCodeString(), randomEmail,
                testcasesData);
