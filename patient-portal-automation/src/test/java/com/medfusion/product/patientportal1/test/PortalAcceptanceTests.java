...
import com.medfusion.product.object.maps.patientportal1.page.forgotPassword.ActivatePasswordChangePage;
import com.medfusion.product.object.maps.patientportal1.page.forgotPassword.ResetYourPasswordPage;
import com.medfusion.product.object.maps.patientportal1.page.forgotPassword.SecretAnswerDoesntMatchPage;
...
import com.medfusion.product.object.maps.patientportal1.page.solutions.apptRequest.ApptRequestHistoryDetailPage;
...
import com.medfusion.product.object.maps.patientportal1.page.solutions.virtualofficevisit.VirtualOfficeVisitConfirmationPage;
import com.medfusion.product.object.maps.patientportal1.page.solutions.virtualofficevisit.VirtualOfficeVisitHistoryDetailPage;
import com.medfusion.product.object.maps.patientportal1.page.solutions.virtualofficevisit.VirtualOfficeVisitHistoryPage;
import com.medfusion.product.object.maps.patientportal1.page.solutions.virtualofficevisit.VirtualOfficeVisitPharmacyPage;
import com.medfusion.product.object.maps.patientportal1.page.solutions.virtualofficevisit.VirtualOfficeVisitProviderPage;
import com.medfusion.product.object.maps.patientportal1.page.solutions.virtualofficevisit.VirtualOfficeVisitQuestionnairePage;
...
public class PortalAcceptanceTests extends BaseTestNGWebDriver {
		 ...
		 * Note :- //need to include a piece of code here for deleting cookies so that script works in IE works
		 */
		...
		public void testAppointmentRequestEnd2End() throws Exception {
				...
				AppointmentRequestStep3Page apptRequestStep3 = apptRequestStep2
						.fillInForm(PortalConstants.PreferredTimeFrame, PortalConstants.PreferredDay, PortalConstants.ChoosePreferredTime, PortalConstants.ApptReason,
		...
		public void testAddNewPatientActivation() throws Exception {
				...
				String unlockLink = patientActivationSearchTest.getPatientActivationLink(driver, practiceTestData, email);
		...
		public void testPayNow() throws Exception {
				...
				assertTrue(pNoLoginPaymentPage
						.validateNoLoginPaymentPage(testcasesData.getFirstName(), testcasesData.getLastName(), testcasesData.getZip(), testcasesData.getEmail()));
		}
		...
		public void testSecureMessageNotification() throws Exception {
				...
				patMessaging.setFieldsAndPublishMessage("SecureMessageTest", "TestPatient1", "Happy Birthday", subject);
