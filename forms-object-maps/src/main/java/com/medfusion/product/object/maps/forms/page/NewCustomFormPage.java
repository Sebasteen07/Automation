...
public class NewCustomFormPage extends PortalFormPage {
	...
	public List<WebElement> getVisibleQuestions() {
		return driver.findElements(By.xpath(
				String.format(QuestionsService.QUESTIONS_BASE_XPATH, currentSection) + "[(count(./li)=1 or ./label)]"));
	}
	...
	public WebElement getVisibleQuestion(int questionOrdinal) {
		return driver.findElement(By.xpath(String.format(QuestionsService.QUESTIONS_BASE_XPATH, currentSection)
	...
	public boolean isTextDisplayed(String text) {
		List<WebElement> textDivs = driver
				.findElements(By.xpath(String.format(QuestionsService.QUESTIONS_BASE_XPATH, currentSection) + "/div"));
	...
	public void consentAllVisibleStatements(String consentString) {
		for (WebElement consentInput : driver.findElements(By.xpath(
				String.format(QuestionsService.QUESTIONS_BASE_XPATH, currentSection) + "[count(./li)=2]/li/input"))) {
	...
	public void clearAllInputs() {
		...
		for (WebElement fupsel : driver
				.findElements(By.xpath(String.format(QuestionsService.QUESTIONS_BASE_XPATH, currentSection)
