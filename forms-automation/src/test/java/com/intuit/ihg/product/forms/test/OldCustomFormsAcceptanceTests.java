...
public class OldCustomFormsAcceptanceTests extends BaseTestNGWebDriver {
		...
		public void testCustomFormPublished() throws Exception {
				...
				CustomFormAddCategoriesPage pCustomFormAddCategories = plinkOnCustomForm
						.enterCustomFormDetails(SitegenConstants.FORMTYPE, customFormTitle, SitegenConstants.FORMINSTRUCTIONS, SitegenConstants.FORMMESSAGE);
		...
		private void testCustomForms(HealthFormListPage pHealthForm) throws Exception {
				...
				SearchPatientFormsResultPage pSearchPatientFormsResultPage = pSearchPatientFormsPage
						.SearchPatientFormsWithOpenStatus(testData.getProperty("patientFirstname"), testData.getProperty("patientLastname"), testData.getDOBMonth(),
