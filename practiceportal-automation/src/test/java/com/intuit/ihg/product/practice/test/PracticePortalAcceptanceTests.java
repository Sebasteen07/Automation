...
public class PracticePortalAcceptanceTests extends BaseTestNGWebDriver {
    ...
    public void testCreateTreatmentPlan() throws Exception {
        ...
        treatmentPlan.createTreatmentPlanInfo(PracticeConstants.treatmentPlanTitle,
                PracticeConstants.treatmentPlanSubject, PracticeConstants.treatmentPlanBody);

        log("Verify whether the treatmentPlan is added Successfully.");
        verifyEquals(treatmentPlan.checkTreatmentPlanSuccessMsg().contains(PracticeConstants.treatmentPlanSuccessMsg),
    ...
    public void testPatientSearchLink() throws Exception {
        ...
        PracticeLoginPage practiceLogin = new PracticeLoginPage(driver, practiceTestData.getUrl());
        PracticeHomePage pPracticeHomePage = practiceLogin.login(practiceTestData.getUsername(),
                practiceTestData.getPassword());
        ...
        pPatientSearchPage.searchForPatientInPatientSearch(PracticeConstants.PatientFirstName,
                PracticeConstants.PatientLastName);
    ...
    public void testChangePatientEmail() throws Exception {
        ...
        log("step 3: Set Patient Search Fields");
        pPatientSearchPage.searchForPatientInPatientSearch(PracticeConstants.chngMailFName,
                PracticeConstants.chngMailLName);

        log("step 4: Open Patient Dashboard");
        PatientDashboardPage pPatientDashboardPage = pPatientSearchPage.clickOnPatient(PracticeConstants.chngMailFName,
                PracticeConstants.chngMailLName);
    ...
    public void testSendUserIdEmail() throws Exception {
        ...
        PatientDashboardPage pPatientDashboardPage = pPatientSearchPage.clickOnPatient(PracticeConstants.frgtFName,
                PracticeConstants.frgtLName);
        ...
        boolean flag = false;
        do {
            boolean foundEmail = CheckEmail.validateForgotUserID(gmail, startEmailSearchDate,
                    practiceTestData.getPatientEmail(), "Your User ID for", practiceTestData.getPatientUser());
            if (foundEmail) {
    ...
    public void testMakePaymentForPatient() throws Exception {
        ...
        assertTrue(pPayMyBillOnlinePage.paymentConfirmationText.getText()
                .contains(PracticeConstants.PaymentSuccessfullText));
    ...
    public void testOnlineBillPayProcess() throws Exception {
        ...
        pPayMyBillOnlinePage.setTransactionsForOnlineBillPayProcess(PracticeConstants.Location,
                PracticeConstants.Provider, PracticeConstants.processCardNum, amount,
                PracticeConstants.ProcessCardHolderName, PracticeConstants.processCardNum,
                PracticeConstants.processCardType);
        ...
        assertTrue(patientsearchPage.isTransactionPresent(amount, PracticeConstants.PatientFirstName,
                PracticeConstants.PatientLastName));

        log("Step 10 : Select the particular Transaction from the Search Result.");
        patientsearchPage.selectTheTransaction(amount, PracticeConstants.PatientFirstName,
                PracticeConstants.PatientLastName);
