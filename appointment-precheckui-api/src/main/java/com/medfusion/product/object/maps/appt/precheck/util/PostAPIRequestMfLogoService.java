...
public class PostAPIRequestMfLogoService extends BaseTestNGWebDriver {
	...
	public Response updateLogoById(String payload, Map<String, String> Header, String logoId) {
	...
	public Response updateLogoByPracticeId(String payload, Map<String, String> Header, String practiceId) {
	...
	public Response uploadLogo(String payload, Map<String, String> Header, String practiceId) {
