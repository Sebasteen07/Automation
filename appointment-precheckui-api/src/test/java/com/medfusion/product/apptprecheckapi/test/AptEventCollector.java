...
public class AptEventCollector extends BaseTestNGWebDriver {
...
//		apiVerification.responseKeyValidationJson(response, "eventSource");
//		apiVerification.responseKeyValidationJson(response, "eventType");
//		apiVerification.responseKeyValidationJson(response, "eventId");
