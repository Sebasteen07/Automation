...
public class PharmacyPaylod {
	static String output = null;

		public static String getPharmacyAddPayload(Pharmacies testData) {
			try {
				...
				externalPharmacyId.appendChild(doc.createTextNode(testData.ExternalPharmacyId));
