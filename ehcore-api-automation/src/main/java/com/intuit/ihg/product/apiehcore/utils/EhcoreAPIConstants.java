			...
			//public static final String HOST = "host";//host = dev3vip-eh-core-svc.qhg.local //protocol = http //port = 80 //reprocessReq_port = 8680
			...
			*/
			...
			/*  //Allscripts-CCD Import
			public static final String as_ccd = "ASCCDImport";
			public static final String as_ccdexport = "ASCCDExport";	*/
			...
			public static final String expectedResponse_BadRequest = "BadRequest";*/
			 ...
			 public static final String AS_RAW = AS_TEST_DATA +"validCCDimport/expected/raw/";
			 
			//Allscripts adapter CCD IMPORT/EXPORT Message Details
			 public static final String AS_CCDEXPORT_RAW = AS_TEST_DATA +"validCCDexport/expected/raw/";
			 public static final String AS_CCDEXPORT_REQ = AS_TEST_DATA +"validCCDexport/input/";
			 public static final String AS_CCDEXPORT_INVALID_REQ = AS_TEST_DATA +"invalidCCDexport/input/";
			 public static final String AS_CCDEXPORT_INVALID_ERROR = AS_TEST_DATA +"invalidCCDexport/expected/error/";
			 
			// public static final String AS_RAW = AS_TEST_DATA +"validCCDimport/expected/raw/";
			 public static final String AS_REQ = AS_TEST_DATA +"validCCDimport/input/";
			 public static final String AS_INVALID_REQ = AS_TEST_DATA +"invalidCCDimport/input/";
			 public static final String AS_INVALID_ERROR = AS_TEST_DATA +"invalidCCDimport/expected/error";
			...
			public static final String QUESTIONNAIRE_EXPORT_DATA_INVALIDKEY= QUESTIONNAIRE_TEST_DATA +"export/validQuestionnaireMessage/input/invalidkey/";
			public static final String QUESTIONNAIRE_EXPORT_DATA_ENRICHED_INVALIDKEY = QUESTIONNAIRE_TEST_DATA + "export/validQuestionnaireMessage/expected/enriched/invalidkey/";
			
			public static final String KEYREGISTRY_ENRICHMENT_RESPONSE = SAMPLE_DATA +"keyregistry_enrichment/";
			//Request xml updates
			...
			//Allscripts Request
			 public static final String AS_REQ1  = AS_REQ + "Professional_AllisonReed_1.xml";
			 public static final String AS_REQ2  = AS_REQ + "C-CCD_mockup_Allscripts_AllisonReed.xml";
			 public static final String AS_REQ3  = AS_REQ + "C-CCD_mockup_Allscripts_HealthyPatient.xml";
			 
			 //QuestionnaireExport Message Details 
			 public static final String QUESTIONNAIRE_EXPORT_DATA = QUESTIONNAIRE_TEST_DATA +"export/validQuestionnaireMessage/input/";
			 public static final String SAMPLE_QUESTIONNAIRE_EXPORT_DATA = QUESTIONNAIRE_SAMPLE_DATA +"export/validQuestionnaireMessage/input/";
			 public static final String QUESTIONNAIRE_EXPORT_DATA_RAW = QUESTIONNAIRE_TEST_DATA + "export/validQuestionnaireMessage/expected/raw/";
			 public static final String QUESTIONNAIRE_EXPORT_DATA_ENRICHED = QUESTIONNAIRE_TEST_DATA + "export/validQuestionnaireMessage/expected/enriched/";
			 ...
			 public static final String INVALID_QUESTIONNAIRE_EXPORT_DATA = QUESTIONNAIRE_TEST_DATA + "export/invalidQuestionnaireMessage/input/";
			 public static final String QUESTIONNAIRE_EXPORT_DATA_ERROR = QUESTIONNAIRE_TEST_DATA + "export/invalidQuestionnaireMessage/expected/error/";
			 public static final String SAMPLE_INVALID_QUESTIONNAIRE_EXPORT_DATA = QUESTIONNAIRE_SAMPLE_DATA +"export/invalidQuestionnaireMessage/input/";
			 
			 
			 /**
			  * Questionnaire Message - Outbound Flow details(Questionnaire ==>Allscripts)
			  */
			
			 //Allscripts adapter QuestionnaireExport Message Details
			 public static final String SAMPLE_ALLSCRIPTS_FORMS_EXPORT_EXPECTED = QUESTIONNAIRE_TEST_DATA +"export/allscripts_ehr/validQuestionnaireMessage/expected/";
			 public static final String INVALID_ALLSCRIPTS_EXPORT_DATA = QUESTIONNAIRE_TEST_DATA +"export/allscripts_ehr/invalidQuestionnaireMessage/input/";
			 public static final String INVALID_ALLSCRIPTS_EXPORT_EXPECTED = QUESTIONNAIRE_TEST_DATA +"export/allscripts_ehr/invalidQuestionnaireMessage/expected/error/";
