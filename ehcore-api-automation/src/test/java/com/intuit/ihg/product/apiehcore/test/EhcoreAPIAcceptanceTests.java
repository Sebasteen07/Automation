...
public class EhcoreAPIAcceptanceTests extends BaseTestNGWebDriver {
	 ...
	 * @StepsToReproduce:
	 * 
	 * 										Test -Open Data Job with Transmission Status "INIT". Check the Response Code and Status in Tracking DB Expected result is that it should
	 *                    work fine-200 OK ======================================================
	 * 
	 ...
	 * @StepsToReproduce:
	 * 
	 * 										Test -Open Data Job with Transmission Status "INIT". Test-Open Two Datajob's and Check datajob id's are different. Expected result is
	 *                    that it should work fine -200 OK ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-04/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-Open Datajob with invalid content-type in Request header EDI should return an error.415 -Unsupported Media Type
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-04/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-Open Datajob with null content-type in Request header EDI should return an error.400- BAD REQUEST
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-05/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-Open Datajob without content-type in Request header EDI should return an error.415 UnsupportedMedia type
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-05/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-Open Datajob with invalid URL EDI should return an error.404-Not Found ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-05/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test- open a datajob with an invalid xml by removing required element EDI should return an error.400-Bad Request
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-05/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-open a datajob with invalid element values. EDI should return an error.400-Bad Request
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test- open a datajob with Blank element values. EDI should return an error .400-BAD REQUEST.
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test- open a datajob with null element values. EDI should return an error.400-Bad Request
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test- open a datajob with emptyString element values. EDI should return an error.400-Bad Request
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-Open a Datajob and close the same Expected result is that it should work fine.200-OK
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-Close Datajob with invalid data job id EDI should return an error.400 -BAD REQUEST
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-Close Datajob with null data job id EDI should return an error.400-BAD REQUEST
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-Close Datajob with blank data job id EDI should return an error.400-BAD REQUEST
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test- close datajob without datajobId element EDI should return an error.400-Bad Request
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Tests close datajob with valid djId and other transmission status-Not TRANSMISSION_END EDI should return an error.400-Bad Request
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-Close Datajob with invalid content-type in Request header EDI should return an error.415-Unsupported Media Type
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-Close Datajob with null content-type in Request header EDI should return an error-Response Code -400-BAD REQUEST
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	...
	public void completeDataJobWithNullContentType() throws Exception {
		...
		// close the same datajob with Transmission Status "TRANSMISSION_END"
		EhcoreAPIUtil.requestWithInvalidHeader("closedatajob", djId, TrackingEnumHolder.DATAJOB_STATUS.TRANSMISSION_END.toString(), "null",
				EhcoreAPIConstants.EXPECTEDRESPONSE_BADREQUEST);
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-Close Datajob without content-type in Request header EDI should return an error-Response Code -400 BAD REQUEST(sandbox) or 415
	 *                    -UnsupportedType(Dev2) ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Tests close datajob with invalid url EDI should return an error.404 - Not Found ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Tests close datajob with valid djId & transStatus and invalidXML by removing required element EDI should return an error.400-Bad Request
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test-close a datajob with invalid element values. EDI should return an error.400-Bad Request
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test- close a datajob with Blank element values. EDI should return an error .400-BAD REQUEST.
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Tests close datajob with valid djId and other required elements are null EDI should return an error.400-Bad Request
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test- close a datajob with emptyString element values. EDI should return an error.400-Bad Request
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @Date:-06/Sep/2013
	 * @User Story ID in Rally : test
	 * @StepsToReproduce: Test- Complete datajob with INIT will create a new DatajobID It should work fine and return response 200-OK with new datajobId.
	 *                    ======================================================
	 * @AreaImpacted :- Description
	 * @throws Exception
	 */
	 ...
	 * @StepsToReproduce: Test- Test - check the status of 'Raw Data XSD Validation' in Activity table in Tracking DB for validCCD and assert for it. Expected
	 *                    Result :200 OK with Completed Status =============================================================
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	public void testCCDImportRawDataXSDValidation() throws Exception {
		...
		msgDetails = EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString

		(), CCDIMPORT_MSG_TYPE);
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(msgDetails.get(0).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.VALIDATE.toString
	 ...
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774
	 * @StepsToReproduce: Test - check the status of 'XML Validation ' in Tracking DB for validCCD Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774
	 * @StepsToReproduce: Test - check the status of 'Raw Message Retrieval' in Tracking DB for validCCD Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774
	 * @StepsToReproduce: Test - Test - check the status of 'Id Enrichment of SimpleCDA' in Tracking DB for validCCD Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774
	 * @StepsToReproduce: Test - check the status of 'Actor ID Validation' in Tracking DB for validCCD Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774
	 * @StepsToReproduce: Test - check the status of 'Publish CCD Notification to Hub' in Tracking DB for validCCD Expected Result :202 Accepted
	 * @throws Exception
	 */
	...
	public void testPublishCCDNotificationForValidCCD() throws Exception {
		...
		(), CCDIMPORT_MSG_TYPE);
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(msgDetails.get(0).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.ROUTE.toString
	 ...
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774
	 * @StepsToReproduce: Test - check the status of 'CCD XSD Validation' in Tracking DB for validCCD Expected Result :202 Accepted
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774
	 * @StepsToReproduce: Test - check the status of 'ccd2simpleTranslation' in Tracking DB for validCCD Expected Result :200 OK
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774
	 * @StepsToReproduce: Test - check the status of 'Snapshot Creation Activity' in Tracking DB for validCCD Expected Result :200 OK
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	...
	/**
	 * Test-Transmit CCD input and check the message status(Completed) and datajob_status(Transmission_Start) in Tracking DB. Expected result -HTTP response 200 &
	 * true.
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	public void testCheckTransmissionStart() throws Exception {
		...
		EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, response.getMessageDispatchHeader().getID(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString
	 ...
	 * @Author:Shanthala
	 * @Date:-13/Sep/2013
	 * @User Story ID in Rally : 6774 Test - check the status of 'Raw Message Persistance' in Tracking DB for validCCD Expected Result :200 OK with Completed
	 *       Status
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Author:Shanthala
	 * @Date:-13/Sep/2013
	 * @User Story ID in Rally : 6774 Test - check the status of 'Change Detection Activity' for new patient. Expected Result :200 OK
	 * @throws Exception
	 */
	...
	public void testChangeDetectionForNewPatient() throws Exception {
		...
		msgDetails =
				EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString(), CCDIMPORT_MSG_TYPE);
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(msgDetails.get(0).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.ENRICH.toString(),
				EhcoreAPIConstants.CHANGEDETECTION));
	 ...
	 * @Date:-13/Sep/2013
	 * @User Story ID in Rally : 6774
	 * @StepsToReproduce: Test - check the status of 'DeltaSummaryEnrichmentActivity' in Tracking DB for validCCD Expected Result :202 Accepted
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774
	 * @StepsToReproduce: Test - check the status of 'simple2hubcanonical' in Tracking DB for validCCD Expected Result :200 OK
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774
	 * @StepsToReproduce: Test - check the status of 'Transform Message to an Attachment Service based Claim Check' in Tracking DB for validCCD Expected Result
	 *                    :200 OK
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Author:Shanthala
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774 Test - check the status of 'Enriched Message Persist ' in Tracking DB for validCCD Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774 Test - check the status of 'SnapshotMessagePersist' in Tracking DB for validCCD The Snapshot node in mongoDB returns the
	 *       current response for the new patient. Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774 Test - New Patient :'Delta Message Persist' for Non Consolidated CCD Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Date:-12/Sep/2013
	 * @User Story ID in Rally : 6774
	 * @StepsToReproduce: Test - check the status of 'SnapshotMessageRetrieve' for same patient without any updates(add/update/delete). Expected Result :200
	 *                    OK,Merged Snapshot should return the updated message.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	public void testSnapshotMessageWithNoUpdates() throws Exception {
		...
		msgDetails = EhcoreAPIUtil.verifyExpectedMessageProcStatus(1, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString
	 ...
	 * @StepsToReproduce: Test-Transmit CCD input and check the message status(Completed) and datajob_status(Transmission_Start) in Tracking DB. Expected result
	 *                    -HTTP response 200 & true.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-16/Sep/2013
	 * @User Story ID in Rally : US6779
	 * @StepsToReproduce: Test -Transmit 2 CCD Msgs and check QID's are different. and check the message status(Completed) and datajob status(DONE) in Tracking
	 *                    DB. Expected result -HTTP response 200 & true.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	public void testASImportMessageJobStatusDone() throws Exception {
		...
		msg = EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, response.getMessageDispatchHeader().getID(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString(),
				CCDImportConstants.AS_CCD_IMPORT);
	 ...
	 * @Date:-16/Sep/2013
	 * @User Story ID in Rally : US6779
	 * @StepsToReproduce: Test - check the status of 'Raw Message Persistance ' in Tracking DB for ccdexport Expected Result :202
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	public void testASImportRawMessagePersist() throws Exception {
		...
		// Pass nodeType and get the obj_ref_id in Tracking DB
		EhcoreTrackingDBUtils.getObjRefDetails(msgDetails.get(0).getQid().toString(), TrackingEnumHolder.OBJECTSTORE_NODE_TYPE.RAW.toString
	 ...
	 * @Date:-16/Sep/2013
	 * @User Story ID in Rally : US6779
	 * @StepsToReproduce: Test - check the status of 'XML Validation' in Tracking DB for CCDImportMessage Expected Result :200 OK
	 * @throws Exception
	 */
	...
	public void testASImportXMLValidation() throws Exception {
		...
		(), CCDImportConstants.AS_CCD_IMPORT);
		EhcoreAPIUtil.verifyExpectedDataJobProcStatus(msg.get(0).getDataJob().getDataJobGuid(), TrackingEnumHolder.DATAJOB_STATUS.DONE.toString());
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(msg.get(0).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.VALIDATE.toString
	 ...
	 * @Date:-16/Sep/2013
	 * @User Story ID in Rally : US6779
	 * @StepsToReproduce: Test - check the status of 'Raw Message Retrieval ' in Tracking DB for Questionnaire Export Expected Result :200 OK
	 * @throws Exception
	 */
	...
	public void testASImportRawMessageRetrieval() throws Exception {
		...
		(), CCDImportConstants.AS_CCD_IMPORT);
		EhcoreAPIUtil.verifyExpectedDataJobProcStatus(msg.get(0).getDataJob().getDataJobGuid(), TrackingEnumHolder.DATAJOB_STATUS.DONE.toString());
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(msg.get(0).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.RETRIEVE.toString
	 ...
	 * @Date:-16/Sep/2013
	 * @User Story ID in Rally : US6779
	 * @StepsToReproduce: Test - check the status of 'Translate Smooks 2 CCDExchange' in Tracking DB Expected Result :200 OK
	 * @throws Exception
	 */
	...
	public void testASTranslationSmooks2CcdExchange() throws Exception {
		...
		(), CCDImportConstants.AS_CCD_IMPORT);
		EhcoreAPIUtil.verifyExpectedDataJobProcStatus(msg.get(0).getDataJob().getDataJobGuid(), TrackingEnumHolder.DATAJOB_STATUS.DONE.toString());
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(msg.get(0).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.TRANSLATE.toString
	 ...
	 * @Date:-16/Sep/2013
	 * @User Story ID in Rally : US6779
	 * @StepsToReproduce: Test - check the status of 'DC publish Activity' in Tracking DB for CCDExportMessage Expected Result :200 OK
	 * @throws Exception
	 */
	...
	public void testASImportDCPublishActivity() throws Exception {
		...
		(), CCDImportConstants.AS_CCD_IMPORT);
		EhcoreAPIUtil.verifyExpectedDataJobProcStatus(msg.get(0).getDataJob().getDataJobGuid(), TrackingEnumHolder.DATAJOB_STATUS.DONE.toString());
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(msg.get(0).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.ROUTE.toString
	...
	public void testRawMessageRetrieveForAllScriptAdapterCCDExportMsg() throws Exception {
		...
		msgDetails = EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, response.getMessageId(), TrackingEnumHolder.MESSAGE_STATUS.ERROR.toString
	 ...
	 * @Date:-16/Sep/2013
	 * @User Story ID in Rally : US6782
	 * @StepsToReproduce: Test - check the status of 'Route Message to Practice' in Tracking DB for CCDExportMessage Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Date:-16/Sep/2013
	 * @User Story ID in Rally : US6782
	 * @StepsToReproduce: Test - check the status of 'Translate Simple CCD to CCD' in Tracking DB for ccdexport Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @StepsToReproduce: Test - Test valid ccd export job status Expected Result : Valid CCD export DONE status
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	public void testCCDExportMessageJobStatusType_ERROR() throws Exception {
		...
		EhcoreAPIUtil.verifyExpectedDataJobProcStatus(response.getDataJobId(), TrackingEnumHolder.DATAJOB_STATUS.ERROR.toString());
		/*
		 * ProcessingResponse response = EHCoreUtil.sendCCDExportMessage(UUID.randomUUID().toString(),"validExportMsg");
		 * EHCoreTestUtil.verifyExpectedMessageProcStatus(0,response.getDataJobId(),TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString(),EHCoreTestConsts.
		 * EH_REST_API_Consts.CCDExport); EHCoreTestUtil.verifyExpectedDataJobProcStatus(response.getDataJobId(),TrackingEnumHolder.DATAJOB_STATUS.DONE.toString());
		 */
	 ...
	 * @StepsToReproduce: Test - Expected Result :
	 * @throws Exception
	 */
	 ...
	 * @StepsToReproduce: Test - check the status of 'Translate CDM to CCDExchange' in Tracking DB for CCDExportMessage Expected Result :200 OK
	 * 
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	...
	public void testRouteMsgToPractice() throws Exception {
		...
		ProcessingResponse response = EhcoreAPIUtil.sendCCDExportMessage(UUID.randomUUID().toString(), "validExportMsg");
		// msgDetails =
		EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, response.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.ERROR.toString
	 ...
	 * @StepsToReproduce: Test - Send invalid export message ccd. Expected Result : Processing_Status_Type::ERROR
	 * @throws Exception
	 */
	 ...
	 * @Date:-20/Sep/2013
	 * @User Story ID in Rally : US6795
	 * @StepsToReproduce: Test - Send Invalid CCD message Expected Result : HTTP response message: Bad Request;HTTP response code: 400
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-20/Sep/2013
	 * @User Story ID in Rally : US6795
	 * @StepsToReproduce: Test - Send Invalid CCD message with ***NULL UPN Expected Result : HTTP response message: Bad Request;HTTP response code: 400
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-20/Sep/2013
	 * @User Story ID in Rally : US6795
	 * @StepsToReproduce: Test - Send Invalid CCD message with Blank Message ID Expected Result : HTTP response message: Bad Request,HTTP response code: 400.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-20/Sep/2013
	 * @User Story ID in Rally : US6795
	 * @StepsToReproduce: Test - Send Invalid CCD message with NULL Message ID Expected Result : HTTP response message: Bad Request,HTTP response code: 400.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-20/Sep/2013
	 * @User Story ID in Rally : US6795
	 * @StepsToReproduce: Test - Verify the processing status after sending CCD message with empty string UPN Expected Result : Processing_Status_Type::COMPLETED.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	public void testSendMessageWithEmptyStringUPN() throws Exception {
		...
		EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, response.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString(),
				EhcoreAPIConstants.CCDEXPORT);
	 ...
	 * @Author: bbinisha
	 * @Date:-20/Sep/2013
	 * @User Story ID in Rally : US6795x`
	 * @StepsToReproduce: Test - Send CCD with INVALID Content type and verify the status. Expected Result : HTTP response message: Unsupported Media Type, HTTP
	 *                    response code: 415.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-20/Sep/2013
	 * @User Story ID in Rally : US6795
	 * @StepsToReproduce: Test - Send CCD with NULL contant ype and verify the processing status. Expected Result : HTTP response code: 400, HTTP response
	 *                    message: Bad Request.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-20/Sep/2013
	 * @User Story ID in Rally : US6795
	 * @StepsToReproduce: Test - Send valid message without content type and verify the processing status. Expected Result : HTTP response code: 400, HTTP
	 ...
	 * @Date:-20/Sep/2013
	 * @User Story ID in Rally : US6795
	 * @StepsToReproduce: Test - Send CCD message with invalid URL and verify the processing status. Expected Result : HTTP response code: 400, HTTP response
	 *                    message: Bad Request.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @StepsToReproduce: Test - Test Raw Message Persisitance For InvalidCCDMessage Expected Result :
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @StepsToReproduce: Test - Test -Transmit 2 CCD Msgs and check QID's are different. and Check the message status(Completed) and datajob status(DONE) in
	 *                    Tracking DB. Expected Result : HTTP response 200 & true.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	public void testTwoValidCCDJobStatusDone() throws Exception {
		...
		EhcoreAPIUtil.sendMessage(dj.getDataJobId(), testData.getPatientID(), EhcoreAPIConstants.VALID_CCD);
		msg = EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString

		(), CCDIMPORT_MSG_TYPE);

		EhcoreAPIUtil.sendMessage(dj.getDataJobId(), testData.getPatientID(), EhcoreAPIConstants.VALID_CCD);
		msg = EhcoreAPIUtil.verifyExpectedMessageProcStatus(1, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString
	 ...
	 * @Date:-23/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test - Test -Transmit 2 CCD Msgs(valid & invalid) and Check the message status(Completed,Error) and datajob status(Partially Done) in
	 *                    Tracking DB. Expected Result : HTTP response 200 & true.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test - Test -Transmit invalid CCD and check the message status(Error) and datajob status(Error) in Tracking DB. Expected Result : HTTP
	 *                    response code: 400; HTTP response message: Bad Request & true.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test - Test-Transmit valid ccd with invalid Content type in Header EDI should return an error-Response Code:415 Unsupported Media Type
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test - Test-Transmit valid ccd data with null Content type in Header EDI should return an error-Response Code:400 Bad Request Expected
	 *                    Result : HTTP response code: 400; HTTP response message: Bad Request.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test - Test-Open Datajob without content-type in Request header EDI should return an error.415 UnsupportedMedia type. Expected Result :
	 *                    HTTP response code: 415; HTTP response message: UnsupportedMedia type.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test - Test-Transmit valid ccd data with invalid datajobId EDI should return an error-Response Code:400 Bad Request Expected Result :
	 *                    HTTP response code: 400; HTTP response message: Bad Request.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test - Test-Transmit valid ccd data with null datajobId EDI should return an error-Response Code:400 Bad Request Expected Result : HTTP
	 *                    response code: 400; HTTP response message: Bad Request.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test - Test-Transmit valid ccd with invalid URL EDI should return an error-Response Code:404 Not Found Expected Result : HTTP response
	 *                    code: 404; HTTP response message: Not Found.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test - Test - Transmit invalidCCDExchange( with blank UPN ) EDI shoul return an error -Response 400 BAD REQUEST Expected Result : HTTP
	 *                    response code: 400; HTTP response message: Bad Request.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test - Test - Valid CCD with null UniversalPatientNumber(UPN) Expected Result :: 202 with ERROR@Actor ID validation
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test - Test - valid CCD with empty string UniversalPatientNumber(UPN) Expected Result :: 202 with ERROR@Actor ID validation.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test- Close an already closed datajob. Expected Result :200 OK.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test- Social History Additional Scenarios NullSocialHistory_CCDSample1:CDExchange+Null Code in Social History Expected Result : 202
	 *                    Accepted,Error@CCD XSD Validation <code codeSystem="2.16.840.1.113883.6.96" codeSystemName="SNOMED CT" code=""/>.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	public void testCCDImportNullCodeSocialHistory() throws Exception {
		...
		assertFalse(EhcoreTrackingDBUtils.isActivityStatusCompleted(msgDetails.get(0).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.PERSIST.toString(),
				EhcoreAPIConstants.CCDXSDVALIDATION));
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test- Datajob Status :TRANSMISSION_START.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test- Datajob Status : DONE.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test- Datajob Status : Partially-Done.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test- Datajob Status : Error.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test-NullSocialHistory_CCDSample1:CDExchange+Null Code in Social History Expected Result :202 Accepted,Error@CCD XSD Validation
	...
	public void testCCDImportNullCodeSocialHistory_CCCD() throws Exception {
		...
		msgDetails = EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, response.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString
	 ...
	 * @Date:-24/Sep/2013
	 * @User Story ID in Rally : US6802
	 * @StepsToReproduce: Test-US4990-NoKnown items in Allery,Medication,Problems,Procedures,Results Expected:202 and No response @PHR and Change Detection.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @StepsToReproduce: Test - check the status of 'Raw Data XSD Validation' in Tracking DB for invalidCCD( invalid 'DateOfBirth') Expected Result :400 BAD
	 *                    REQUEST =============================================================
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	public void testCCDImportRawDataXSDValidationForInvalidCCD() throws Exception {
		...
		List<Message> msgDetails = new ArrayList<Message>();
		msgDetails = EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.ERROR.toString(), CCDIMPORT_MSG_TYPE);
		assertFalse(EhcoreTrackingDBUtils.isActivityStatusCompleted(msgDetails.get(0).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.VALIDATE.toString(),
				EhcoreAPIConstants.RAWXSDVALIDATION));
	}
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally : US6799
	 * @StepsToReproduce: C-CCD(Consolidated CCD) Request to check "Raw Data XSD Validation" =============================================================
	 * @throws Exception
	 */
	...
	public void testCCDImportRawDataXSDValidationForInvalid_C_CCD() throws Exception {
		...
		List<Message> msgDetails = new ArrayList<Message>();
		msgDetails = EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.ERROR.toString
	...
	public void testASCCDExportMessageJobStatusTypeDone() throws Exception {
		...
		EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, response.getMessageId(), TrackingEnumHolder.MESSAGE_STATUS.ERROR.toString
	 ...
	 * @Author:Shanthala
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally :US6799 Test - check the status of 'Error Message Persist' in Tracking DB for invalidCCD check the DeadLetterQ status in ActiveMQ.
	...
	public void testErrorRawMsgPersistForCCD() throws Exception {
		...
		msgDetails =
				EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, response.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.ERROR.toString(), CCDIMPORT_MSG_TYPE);
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(msgDetails.get(0).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.PERSIST.toString(),
				EhcoreAPIConstants.ERRORPERSISTANCE));// EhcoreAPIConstants.CCDXSDVALIDATION));
		// Pass nodeType and get the obj_ref_id in Tracking DB
		log("Check mongoDB response using API");
		String obj_ref_id =
				EhcoreTrackingDBUtils.getObjRefDetails(msgDetails.get(0).getQid().toString(), TrackingEnumHolder.OBJECTSTORE_NODE_TYPE.ERROR.toString());
	 ...
	 * @Author:Shanthala
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally :US6799 Test - check the status of 'Raw Message Persistance' in Tracking DB for valid consolidatedCCD Expected Result :200 OK with
	 *       Completed Status
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Author:Shanthala
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally :US6799 C-CCD(Consolidated CCD) Invalid Request to check "Error Message Persist"
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	public void testErrorRawMsgPersistFor_C_CCD() throws Exception {
		...
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(msgDetails.get(0).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.PERSIST.toString(),
				EhcoreAPIConstants.ERRORPERSISTANCE));
	 ...
	 * @Author:Shanthala
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally :US6799 US4990-NoKnown Consolidated CCD items in Allery,Medication,Problems,Procedures,Results Expected:202
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally:US6799
	 * @StepsToReproduce: Test - check the status of 'XML Validation ' in Tracking DB for invalidCCD Expected Result :400 OK,Error @ "XML Validation "
	 *                    Activity,COMPLETED @'Error Message Persist'
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally:US6799
	 * @StepsToReproduce: C-CCD(Consolidated CCD) Request to check "XML Validation " Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally:US6799
	 * @StepsToReproduce: C-CCD(Consolidated CCD) invalid Request to check "XML Validation " Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally:US6799
	 * @StepsToReproduce: C-CCD(Consolidated CCD) Request to check "Raw Message Retrieval " Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally:US6799
	 * @StepsToReproduce: C-CCD(Consolidated CCD) Request to check "Id Enrichment activity " Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally:US6799
	 * @StepsToReproduce: C-CCD(Consolidated CCD) Request to check "Actor ID Validation " Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally:US6799
	 * @StepsToReproduce: C-CCD(Consolidated CCD) Request to check "ccd2simpleTranslation" Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally:US6799
	 * @StepsToReproduce: C-CCD(Consolidated CCD) Request to check "Snapshot Creation Activity" Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally:US6799
	 * @StepsToReproduce: C-CCD(Consolidated CCD) Request to check "CCD XSD Validation (Delta Enrichment) " Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally:US6799
	 * @StepsToReproduce: C-CCD(Consolidated CCD) Request to check "simple2hubcanonical" Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally:US6799
	 * @StepsToReproduce: C-CCD(Consolidated CCD) Request to check "Transform Message to an Attachment Service based Claim Check" Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-11/Oct/2013
	 * @User Story ID in Rally:US6799
	 * @StepsToReproduce: C-CCD(Consolidated CCD) Request to check "Publish CCD Canonical to Hub" Expected Result :200 OK
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @StepsToReproduce: Test - check the status of 'Publish CCD Notification to Hub' in Tracking DB for In validCCD Expected Result :202 Accepted
	 * @throws Exception
	 */
	...
	public void testPublishCCDNotificationForInValidCCD() throws Exception {
		...
		ProcessingResponse response =
				EhcoreAPIUtil.sendMessage("", EhcoreAPIConstants.INTUITPATIENTID_INVALIDCCDNOTIFICATION, EhcoreAPIConstants.INVALID_CCD_NOTIFICATION);
		List<Message> msgDetails = new ArrayList<Message>();
		msgDetails =
				EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, response.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.ERROR.toString(), CCDIMPORT_MSG_TYPE);
	 ...
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: Test - check the status of 'Publish CCD Notification to Hub' in Tracking DB for Invalid C_CCD Expected Result :202 Accepted
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: C-CCD(Consolidated CCD) Request to check "CCD XSD Validation" Expected Result :202 Accepted
	 * @throws Exception
	 */
	 ...
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: Test - Request to check "CCD XSD Validation" in Tracking DB for Invalid CCD
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: Invalid C-CCD(Consolidated CCD) Request to check "CCD XSD Validation"
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Author:Shanthala
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901 Test - //check the status of 'Enriched Message Persist ' for C_CCD Expected Result :200 OK
	 * @throws Exception
	 */
	...
	public void testEnrichedMsgPersistForValid_C_Ccd() throws Exception {
		...
		log("Check mongo DB status using API");
		String obj_ref_id =
				EhcoreTrackingDBUtils.getObjRefDetails(msgDetails.get(0).getQid().toString(), TrackingEnumHolder.OBJECTSTORE_NODE_TYPE.ENRICHED.toString());
		EhcoreAPIUtil.verifyMongoDBResponseUsingAPI(TrackingEnumHolder.OBJECTSTORE_NODE_TYPE.ENRICHED.toString(), obj_ref_id, expectedCcd);
	}
	 ...
	 * @Author:Shanthala
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901 US4990-NoKnown Consolidated CCD items in Allery,Medication,Problems,Procedures,Results Expected:202
	 * @throws Exception
	 */
	 ...
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: Test - check the status of 'SnapshotMessageRetrieve' for same patient with added details. Added 2 Problem Sections. Expected Result :200
	 *                    OK & Merged Snapshot should return the updated message
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: Transmit CCD with Added details for the same patient(with same subject_id). Added @ element level (Medication -DrugCode -Displayname)
	 ...
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: Test - check the status of 'SnapshotMessageRetrieve' for same patient with updated details. Updated Allergy_1 Section Expected Result
	 *                    :200 OK &Merged Snapshot should return the updated message.
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: Test - check the status of 'SnapshotMessageRetrieve' for same patient with deleted details. Deleted one Immunization section. Expected
	 *                    Result :200 OK & check Merged Snapshot outcome .it will merge with previous snapshot and show all the sections including deleted
	 *                    message.
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	public void testSnapshotWithDeletedMessage() throws Exception {
		...
		msgDetails = EhcoreAPIUtil.verifyExpectedMessageProcStatus(2, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString
	 ...
	 * @Author:Shanthala
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901 Consolidated CCD - check the status of 'SnapshotMessageRetrieve' for same patient without any updates(add/update/delete).
	 ...
	 * @Author:Shanthala
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901 Test - check the status of 'SnapshotMessageRetrieve' for same patient with added details. Added 1 Vital sign component.
	 ...
	 * @Author:Shanthala
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901 Test - check the status of 'SnapshotMessageRetrieve' for same patient with updated details. Updated Allergy_1 Section
	 *       Expected Result :200 OK &Merged Snapshot should return the updated message.
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Author:Shanthala
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901 Consolidated CCD - check the status of 'SnapshotMessageRetrieve' for same patient with deleted details. Deleted one
	 *       Immunization section. Expected Result :202 ACCEPTED & check Merged Snapshot outcome .it will merge with previous snapshot and show all the sections
	 *       including deleted message.
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Author:Shanthala
	 * @Date:-16/Oct/2013
	 * @User Story ID in Rally : US6901 C-CCD(Consolidated CCD) Request to check "SnapshotMessagePersist"
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - check the status of 'Change Detection Activity' for same patient without any updates(add/update/delete). Expected
	 *       Result :200 OK,The Actual CDMList should return null if no updates.
	 * @throws Exception
	 */
	...
	public void testCDWithNoUpdates() throws Exception {
		...
		/**
		 * It shows complete CCDMessage with NoUpdates in CCD Items for ex:<AllergyList/> Get the Actual CDM Message and compare with expected using message_guid in
		 * MongoDB
		 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - check the status of 'Change Detection Activity' for same patient with added details. Added 2 Problem Sections.
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - check the status of 'Change Detection Activity' for same patient with updated details. Updated Allergy_1 Section
	...
	public void testCDWithUpdatedDetails() throws Exception {
		...
		EhcoreAPIUtil.sendUpdatedMessage(dj.getDataJobId(), msgDetails.get(0).getSubjectId(), EhcoreAPIConstants.updateCCD);
		msgDetails =
				EhcoreAPIUtil.verifyExpectedMessageProcStatus(1, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString(), CCDIMPORT_MSG_TYPE);
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(msgDetails.get(1).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.ENRICH.toString(),
				EhcoreAPIConstants.CHANGEDETECTION));
		/**
		 * To get the Added CDM List we need to check the second message in this subject_id.
		 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - check the status of 'Change Detection Activity' for same patient with deleted details. Deleted one Immunization
	 *       section. Expected Result :200 OK & Actual CDMList should return null.
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Check change detection for New patient for consolidated CCD
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Check change detection for existing patient for consolidated CCD
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Add Entity Consolidated CCD -(Added VitalSign Component)
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Update Consolidated CCD -(Updated Vital Sign Displayname)
	 * @throws Exception
	 */
	...
	public void testCDWithUpdate_CCCD() throws Exception {
		...
		cCCDmsgDetails =
				EhcoreAPIUtil.verifyExpectedMessageProcStatus(0, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString(), CCDIMPORT_MSG_TYPE);
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(cCCDmsgDetails.get(0).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.ENRICH.toString(),
				EhcoreAPIConstants.CHANGEDETECTION));

		// Send the same message with updated details(updated Allery section)
		EhcoreAPIUtil.sendUpdatedMessage(dj.getDataJobId(), cCCDmsgDetails.get(0).getSubjectId(), EhcoreAPIConstants.updateC_CCD);
		cCCDmsgDetails =
				EhcoreAPIUtil.verifyExpectedMessageProcStatus(1, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString(), CCDIMPORT_MSG_TYPE);// cCCDmsgDetails.get(0).getQid().toString());
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(cCCDmsgDetails.get(1).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.ENRICH.toString(),
				EhcoreAPIConstants.CHANGEDETECTION));

		/**
		 * To get the Added CDM List we need to check the second message in this subject_id.
		 */
		cCCDmsgDetails = EhcoreAPIUtil.verifyExpectedMessageProcStatus(1, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString(),
				cCCDmsgDetails.get(0).getQid().toString());
		// Get the Actual CDM Message and compare with expected using message_guid in MongoDB
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Delete Consolidated CCD
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 NoKnown Consolidated CCD-New Patient
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - NoUpdates @2ndRun :'Delta Message Persist' for Non Consolidated CCD Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - AddEntity @2ndRun :'Delta Message Persist' for Non Consolidated CCD Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - AddElement @2ndRun :'Delta Message Persist' for Non Consolidated CCD Expected Result :200 OK
	 * @throws Exception
	 */
	...
	public void testDeltaMsgPersist_AddElement() throws Exception {
		...
		msgDetails =
				EhcoreAPIUtil.verifyExpectedMessageProcStatus(1, dj.getDataJobId(), TrackingEnumHolder.MESSAGE_STATUS.COMPLETED.toString(), CCDIMPORT_MSG_TYPE);
		assertTrue(EhcoreTrackingDBUtils.isActivityStatusCompleted(msgDetails.get(1).getQid().toString(), TrackingEnumHolder.ACTIVITY_TYPE.PERSIST.toString(),
				EhcoreAPIConstants.DELTAMESSAGEPERSIST));
		// Pass nodeType and get the obj_ref_id in Tracking DB
		String obj_ref_id =
				EhcoreTrackingDBUtils.getObjRefDetails(msgDetails.get(1).getQid().toString(), TrackingEnumHolder.OBJECTSTORE_NODE_TYPE.DELTA.toString());
		System.out.println("obj_ref_id::" + obj_ref_id);
		EhcoreAPIUtil.verifyMongoDBResponseUsingAPI(TrackingEnumHolder.OBJECTSTORE_NODE_TYPE.DELTA.toString(), obj_ref_id, expectedResponse);
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - AddElement @2ndRun :'Delta Message Persist' for Non Consolidated CCD - Updated details Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - AddElement @2ndRun :'Delta Message Persist' for Non Consolidated CCD - delete details Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 C-CCD(Consolidated CCD) Request to check "Delta Message Persist" Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - NoUpdates @2ndRun :'Delta Message Persist' for Consolidated CCD Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - AddEntity @2ndRun :Verify 'Delta Message Persist' for Consolidated CCD Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - UpdateEntity @2ndRun :Verify 'Delta Message Persist' for Consolidated CCD Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Author:Shanthala
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901 Test - DeleteEntity @2ndRun :Verify 'Delta Message Persist' for Consolidated CCD Expected Result :200 OK
	 * @throws Exception
	 */
	 ...
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: Test-Transmit invalid message and create a business exception. check response code , message status(Error) and datajob status (Error) in
	 *                    Tracking DB. Expected result -HTTP response 200 & true.
	 * @throws Exception
	 */
	 ...
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: Test-Transmit valid message with invalid Content type in Header EDI should return an error-Response Code:415 Unsupported Media Type
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: Test-Transmit valid message with null Content type in Header EDI should return an error-Response Code:400 Bad Request
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: Test-Transmit valid message without Content type in Header EDI should return an error.415 UnsupportedMedia type
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-16/Sep/2013
	 * @User Story ID in Rally : US6782
	 * @StepsToReproduce: Test-Transmit valid ccd with invalid URL EDI should return an error-Response Code:404 Not Found
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
	 ...
	 * @Date:-17/Oct/2013
	 * @User Story ID in Rally : US6901
	 * @StepsToReproduce: Test - Transmit invalid CCDMessageType,create business exceptiona & check Message status (Error)in tracking db & check DeadLetterQ
	 *                    status in ActiveMQ. Expected Result :202 with Error Message Status.
	 * @throws Exception
	 */
	@Test(enabled = true, groups = {"Allscripts_Acceptance", "Allscripts_Functional"}, retryAnalyzer = RetryAnalyzer.class)
