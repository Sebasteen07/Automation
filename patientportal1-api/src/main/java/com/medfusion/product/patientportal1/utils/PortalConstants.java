...
public class PortalConstants {
    ...
    /*
     * TO REFACTOR: Constant naming should be consistent, ideally according Java standards - Use ALL_UPPER_CASE for your
     * named constants, separating words with the underscore character.
     */
