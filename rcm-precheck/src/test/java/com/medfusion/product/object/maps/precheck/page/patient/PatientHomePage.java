...
public class PatientHomePage extends BasePageObject {
	...
	@FindBy(how = How.XPATH, 
			using = "//div[@id='demographicsWrapper']/span[@class='fa fa-fw fa-lg fa-check'][@aria-hidden='false']")
	private WebElement demographicsCheckMark;
	
	@FindBy(how = How.XPATH, 
			using = "//div[@id='insuranceWrapper']/span[@class='fa fa-fw fa-lg fa-check'][@aria-hidden='false']")
