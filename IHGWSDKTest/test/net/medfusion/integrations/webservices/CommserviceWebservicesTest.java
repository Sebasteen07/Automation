...
public class CommserviceWebservicesTest {
	...
	private static SimpleDateFormat tsdf = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SS");
	...
	public void testpostNewCommunication() {
		...
		try {
			...
			service1.postNewCommunication("Saurav", "Ghosh", "05231987", null, "A message", "This is a message to send", tsdf.format(new Date()), 8);
			// lineBreak();
		} catch (Exception e) {
