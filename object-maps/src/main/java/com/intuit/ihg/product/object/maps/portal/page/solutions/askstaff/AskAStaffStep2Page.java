...
public class AskAStaffStep2Page extends BasePageObject {
	...
	/**
	 * Review Ask A Staff details, including payment details when fee's are turned on,
	 * and finally submit the question.
	 * 
	...
	/**
	 * May need to break this out to its own class
	 * if this is the same across all solutions that
	 * charge a fee (maybe include the ability to indicate which card)
	 * 
