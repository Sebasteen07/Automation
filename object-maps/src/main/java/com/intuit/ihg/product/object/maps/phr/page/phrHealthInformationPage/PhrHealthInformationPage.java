...
public class PhrHealthInformationPage extends BasePageObject{
	...
	{
		PhrUtil.PrintMethodName();
		List<Object> list=IHGUtil.searchResultTable(driver,"//table[@id='custom_table_list_id']/tbody",new ArrayList<String>(Arrays.asList("UroXatral (alfuzosin), Extende...")));
		if(!list.isEmpty())
		{
	...
	{
		PhrUtil.PrintMethodName();
		List<Object> list=IHGUtil.searchResultTable(driver,"//table[@id='custom_table_list_id']/tbody",new ArrayList<String>(Arrays.asList("Abdominal Surgery")));
		if(!list.isEmpty())
		{
			BaseTestSoftAssert.assertTrue(((Boolean) list.get(1)).booleanValue());
		}
	...
	{
		PhrUtil.PrintMethodName();
		List<Object> list=IHGUtil.searchResultTable(driver,"//table[@id='custom_table_list_id']/tbody",new ArrayList<String>(Arrays.asList("Adenovirus - Type 4, live, ora...")));
		if(!list.isEmpty())
		{
			BaseTestSoftAssert.assertTrue(((Boolean) list.get(1)).booleanValue());
		}
