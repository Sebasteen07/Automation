package com.intuit.ihg.product.object.maps.portal.page.symptomAssessment;
...
public class NewSymptomAssessmentPage extends BasePageObject{
	...
	/**
	 * selectProvider
	 * select a provider from drop down and submit
	 * @param doctor
	 */
	/*public void selectProvider(String doctor) {
		...
		provider.selectByVisibleText(doctor);
		btnSubmit.click();
	}*/
	public void selectProvider(String doctor)
	{
