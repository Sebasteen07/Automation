		...
		If(WinActive("Chart - NOT FOR PATIENT USE")) Then
			...
			Do
				If($arrConfig[9]=="Data Generation") Then
					ConsoleWrite("Creating Office Visit #" & $counter+1 & " of " & $arrConfig[51] & " office visits"& @CRLF)
					FileWriteLine($hFileOpen, _NowCalc() & "  -- Creating Office Visit #" & $counter+1 & " of " & $arrConfig[51] & " office visits" & @CRLF)
				Else
				...
				Else
					$counter = $arrConfig[51]
				EndIf
			Until $counter = $arrConfig[51]
