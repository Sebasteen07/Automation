...
public class JalapenoAskAStaffPage extends BasePageObject {
    ...
    public boolean fillAndSubmitAskAStaff(WebDriver driver) {
        ...
        new WebDriverWait(driver, 20)
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='viewContent']/div[1]/h2")));
        ...
        new WebDriverWait(driver, 20)
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(text(), 'Home')]")));
        return true;
    }
    ...
    public boolean checkHistory(WebDriver driver) {
        ...
        try {
            new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(
                    By.xpath("//*[contains(text(), '" + "Ola! " + this.getCreatedTimeStamp() + "')]")));
