...
public class JalapenoSymptomAssessmentPage extends MedfusionPage {
	...
	public boolean isPageLoaded() {
		...
		try {
			result = new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOf(dropDownProvider)).isDisplayed();
		} catch (Exception e) {
