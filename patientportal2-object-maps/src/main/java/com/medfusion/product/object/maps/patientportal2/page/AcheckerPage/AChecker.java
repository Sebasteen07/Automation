...
public class AChecker extends BasePageObject {
	...
	// Navigates to Paste HTML Markup and sets the options to WCAG 2.0 (Level
	// A/AA/AAA)
	...
	// Assuming the validation window is selected, paste from clipboard, click
	// validate and wait for spinner
