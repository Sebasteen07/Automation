...
public class HealthKeyMatchTest extends BaseTestNGWebDriver {
    ...
    public MyPatientPage healthKey66SamePracticeMatch(WebDriver driver, TestcasesData testcasesData) throws Exception {
        ...
        CreateAccountExistingUserPage pCreateAccountExistingUserPage = pCreateAccountPage.tryCreateExistingUser(
                testcasesData.getFirstName(), testcasesData.getLastName(), testcasesData.getZip(),
                testcasesData.getSSN(), testcasesData.getEmail(), testcasesData.getDob_Month(),
                testcasesData.getDob_Day(), testcasesData.getDob_Year());

        assertTrue(pCreateAccountExistingUserPage.existingPageVerify(driver));

        log("step 4: Log in with existing account");
        MyPatientPage pMyPatientPage = pCreateAccountExistingUserPage.logIn(testcasesData.getEmail(),
    ...
    public MyPatientPage healthKey66DifferentPracticeMatch(WebDriver driver, TestcasesData testcasesData, String email,
        ...
        log("step 3: Fill detials in Create Account Page");
        log("email:-" + email);
        CreateAccountHealthKeyPage pCreateAccountHelthKeyPage = pCreateAccountPage.tryCreateExistingUserDiffPrac(
                firstName, lastName, testcasesData.getZip(), testcasesData.getSSN(), email,
                testcasesData.getDob_Month(), testcasesData.getDob_Day(), testcasesData.getDob_Year());
    ...
    public MyPatientPage healthKey56SamePracticeMatch(WebDriver driver, TestcasesData testcasesData) throws Exception {
        ...
        log("email:-" + testcasesData.getEmail());
        CreateAccountExistingUserPage pCreateAccountExistingUserPage = pCreateAccountPage.tryCreateExistingUser(
                testcasesData.getFirstName(), "tester", testcasesData.getZip(), testcasesData.getSSN(),
        ...
        CreatePatientVerifyPhonePage pCreatePatientVerifyPhonePage = pCreateAccountExistingUserPage
                .clickVerifyPhone(driver);
    ...
    public MyPatientPage healthKey56DifferentPracticeMatch(WebDriver driver, TestcasesData testcasesData, String email,
            String firstName, String lastName) throws Exception {
        ...
        log("step 4: Verify the patient by phone");
        CreatePatientVerifyPhonePage pCreatePatientVerifyPhonePage = pCreateAccountHelthKeyPage
                .clickVerifyPhone(driver);
        pCreatePatientVerifyPhonePage.fillPhone(driver, testcasesData.getPhoneNumber());
