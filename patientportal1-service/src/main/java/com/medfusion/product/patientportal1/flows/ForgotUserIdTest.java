...
public class ForgotUserIdTest extends BaseTestNGWebDriver {
    ...
    public void forgotUserIdTest(WebDriver driver, TestcasesData testcasesData) throws Exception {
        ...
        assertTrue(step3.confirmationPageLoaded(),
                "There was an error loading the confirmation page in the Forgot UserId workflow");
    ...
    public String mixCase(String inputStr) {
        ...
        for (int i = 0; i < inputStr.length(); i++) {
            char mixCase = ((i % 2) == 1) ? Character.toUpperCase((inputStr.charAt(i)))
                    : Character.toLowerCase((inputStr.charAt(i)));
