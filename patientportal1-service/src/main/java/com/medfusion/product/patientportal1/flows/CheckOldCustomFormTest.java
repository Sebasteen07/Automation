...
public class CheckOldCustomFormTest extends BaseTestNGWebDriver {
    ...
    public HealthFormPage checkOldCustomForm(WebDriver driver, TestcasesData testcasesData, String formName)
        ...
        // verifyEquals(verifyTextPresent(driver,"Insurance Type"),true,"Insurance Type is not present in form on
        // Portal");
        ...
        verifyEquals(verifyTextPresent(driver, "completed 2 of 3 pages"), true,
