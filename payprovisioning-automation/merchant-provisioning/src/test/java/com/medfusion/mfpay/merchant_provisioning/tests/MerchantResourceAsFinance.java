...
public class MerchantResourceAsFinance extends BaseRest {
  ...
  public void testGetSettlementType() throws Throwable {
      ...
      Assert.assertEquals(jsonPath.get("qualifiedUpperBoundaryPercent").toString(), qualifiedUpperBoundaryPercent.toString());

      Assert.assertNotNull(jsonPath.get("midQualifiedUpperBoundaryPercent"));
      Assert.assertEquals(jsonPath.get("midQualifiedUpperBoundaryPercent").toString(), midQualifiedUpperBoundaryPercent.toString());
