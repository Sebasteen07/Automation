...
**/
    ...
    public void testCreatePatientHealthKey6outOf6Inactive() throws Exception {
        ...
        patientDemographicPage.fillInPatientData(patientActivationSearchTest.getFirstNameString(), patientActivationSearchTest.getLastNameString(),
                ...
                Gender.MALE, PracticeConstants.Zipcode);
        patientDemographicPage.tryToContinueToSecurityPage();
    ...
    public void testAskAStaffV2() throws Exception {        
        ...
        assertTrue(askaSubject.equals(askHistoryDetail.getRequestDetailSubject()), "Expected: " + askaSubject + ", found: " + askHistoryDetail.getRequestDetailSubject());
        assertTrue(questionText.equals(askHistoryDetail.getRequestDetailQuestion()), "Expected: " + questionText + ", found: " + askHistoryDetail.getRequestDetailQuestion());
        ...
        assertTrue(askaSubject.equals(askHistoryDetail.getRequestDetailSubject()), "Expected: " + askaSubject + ", found: " + askHistoryDetail.getRequestDetailSubject());
        assertTrue(questionText.equals(askHistoryDetail.getRequestDetailQuestion()), "Expected: " + questionText + ", found: " + askHistoryDetail.getRequestDetailQuestion());
        assertTrue("Completed".equals(askHistoryDetail.getRequestDetailStatus()), "Expected: Completed" + ", found: " + askHistoryDetail.getRequestDetailStatus());
        logStep("Logout patient");
        askHistoryDetail.clickOnLogout();
