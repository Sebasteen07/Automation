...
import com.medfusion.product.object.maps.jalapeno.page.MyAccountPage.JalapenoNewMyAccountPage;
...
public class JalapenoAcceptanceTests extends BaseTestNGWebDriver {
    ...
    public void testMyAccount() throws Exception {
        ...
        log("Opening and checking My Account page");
        // UNCOMMENT after My Account page will be accessible via common way
        // JalapenoMyAccountPage myAccountPage = homePage.clickOnMyAccount(driver);
        JalapenoNewMyAccountPage jalapenoNewMyAccountPage = new JalapenoNewMyAccountPage(driver);
        // TO DELETE START after My Account page will be accessible via common way
        driver.get(testData.getUrl() + "#/user/account2");
        // TO DELETE END

        assertTrue(jalapenoNewMyAccountPage.assessPageElements());

        Map<WebElement, String> itemsToChange = new HashMap<WebElement, String>();
        itemsToChange.put(jalapenoNewMyAccountPage.getAddress1Textbox(), "address");
        itemsToChange.put(jalapenoNewMyAccountPage.getCityTextbox(), "city");
        itemsToChange.put(jalapenoNewMyAccountPage.getStateSelect(), "Alaska");
        itemsToChange.put(jalapenoNewMyAccountPage.getZipCodeTextbox(), "54321");

        log("Modifying and checking My Account page");
        assertTrue(jalapenoNewMyAccountPage.updateAndValidateWebElements(itemsToChange));
    }
}
