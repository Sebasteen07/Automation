...
public class DataJobConstant {
	...
	public static final String SAMPLE_CDM_LIST = SAMPLE_DATA + "changedetectionmessage/expected/entity/";
	public static final String ACTUAL_CDM_LIST = SAMPLE_DATA + "changedetectionmessage/actual/testactual/";
