...
//	private final static String GMAIL_IMAP_PORT = "993";
	...
	public GmailCommunity(String id, String pwd) {
		this.id = id;
		this.pwd = pwd;
	}
	...
	public Message[] findInTrash(String recipient, String subject, Date startDate) throws MessagingException, IOException {
		if (!connected) {
			connect();
		}
		...
		Message[] messages = getMessages("[Gmail]/Trash", terms);
