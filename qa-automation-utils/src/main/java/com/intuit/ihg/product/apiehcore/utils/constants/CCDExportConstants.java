...
public class CCDExportConstants {
	...
	public static final String AS_CCDEXPORT_INVALID_ERROR = AS_CCDEXPORT_TEST_DATA + "invalid/expectedresponse/";
	...
	public static final String SAMPLE_ALLSCRIPTS_FORMS_EXPORT_INPUT_DATA = QUESTIONNAIRE_TEST_DATA + "export/allscripts_ehr/validQuestionnaireMessage/input/";
	...
	public static final String QUESTIONNAIRE_EXPORT_DATA_ENRICHED_INVALIDKEY =
			QUESTIONNAIRE_TEST_DATA + "export/validQuestionnaireMessage/expected/enriched/invalidkey/";
