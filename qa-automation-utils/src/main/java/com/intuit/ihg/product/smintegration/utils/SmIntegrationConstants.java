...
public class SmIntegrationConstants {
	...
	public static final String PATIENT_REGISTRATION_REQUEST = TEST_DATA
			+ IHGUtil.getEnvironmentType() + "/patientregistration/";
	public static final String PATIENT_REGISTRATION_RESPONSE = SAMPLE_DATA
			+ IHGUtil.getEnvironmentType() + "/patientregistration/";
	...
	public static final String PATIENT_HEALTH_REMINDER_REQUEST = TEST_DATA
			+ IHGUtil.getEnvironmentType() + "/healthreminder/";
	public static final String PATIENT_HEALTH_REMINDER_RESPONSE = SAMPLE_DATA
			+ IHGUtil.getEnvironmentType() + "/healthreminder/";
	...
	public final static String PATIENTHEALTH_REMINDER_OUTBOUND_MESSAGE_SUBJECT = "Please get back ASAP! 17-APRIL-2013__NOUNVERBIDENTIFIER__HealthReminder__NOUNVERBIDENTIFIER__Acknowledged";
	public final static String PATIENTHEALTH_REMINDER_OUTBOUND_MESSAGE_BODY = "Health Reminder has been read by the Patient";
	
	// Patient Invite
	public static final String PATIENT_INVITE_REQUEST = TEST_DATA
			+ IHGUtil.getEnvironmentType() + "/patientinvite/";
	public static final String PATIENT_INVITE_RESPONSE = SAMPLE_DATA
			+ IHGUtil.getEnvironmentType() + "/patientinvite/";
	...
	public static final String APPOINTMENT_REQUEST_PATH = TEST_DATA
			+ IHGUtil.getEnvironmentType() + "/appointmentRequest/";
	public static final String APPOINTMENT_RESPONSE_PATH = SAMPLE_DATA
			+ IHGUtil.getEnvironmentType() + "/appointmentRequest/";
	...
	public static final String APPOINTMENT_REQUEST = TEST_DATA
			+ IHGUtil.getEnvironmentType() + "/appointmentRequest/";
	...
	public static final String PROVIDERINITIATEDMESSAGE_REQUEST = TEST_DATA
			+ IHGUtil.getEnvironmentType() + "/providerInitiatedMessage/";
	public static final String PROVIDERINITIATEDMESSAGE_RESPONSE = SAMPLE_DATA
			+ IHGUtil.getEnvironmentType() + "/providerInitiatedMessage/";
