...
/**
 * Created by IntelliJ IDEA. User: vvalsan Date: 3/26/13 Time: 4:16 PM To change this template use File | Settings | File Templates.
 */
public class RxRenewal {
	...
	// All data
	public RxRenewal(boolean newMed, boolean newPharmacy, boolean searchForPharmacy, boolean findPharmacyNearMe, String rxName, String dosage, String comments,
			String pharmacyName, String pharmacyPhone, String zipOrStateToSearch, String doctor) {
		isNewMed = newMed;
		isNewPharmacy = newPharmacy;
		this.searchForPharmacy = searchForPharmacy;
		this.findPharmacyNearMe = findPharmacyNearMe;
