...
public class IHGUtil extends BasePageObject {
    ...
    public enum SupportedWebElements {
        SELECT,
        TEXT
    }
     ...
     * 
     * @param <myList>
     *            : Multiple lists with comma (,) separation
     * @param first
     * @param rest
     ...
     * 
     * @param webelements
     *            : example "sdputil.exists(By.xpath("//input[@name='email']"))"
     * @return boolean
     */
    ...
    /**
     * Desc:-Will fisrt wait implicitly then will check if element exist or not . Will return true if Element exist else
     * false
     * 
     * @param element
     ...
     * @param webelements
     * @param maxTimeInSecondsToWait
     *            : timeout for the function. Max time to wait.
     * @return boolean
     */
    ...
    public static String getFormattedCurrentDate(String typeOfDateFormat) throws Exception {
        ...
        if (typeOfDateFormat.equals("dd")) {
            ...
            // This Modification is required for Event Logger as it displays time like 9:51:23 instead 09:51:23, this
     ...
     * 
     * @param dateFormat
     *            [String] date format i.e "MM/dd/yyyy", dd/MM/yyyy etc
     * @param days
     *            [int] number of days i.e. -7, 15
     * @return
     * @throws Exception
     */
     ...
     * 
     * @param listToSearchFrom:
     *            List from which the item is to be searched.
     * @param searchItem:
     *            Item that has to be searched in the list.
     ...
     * 
     * @param el
     *            The WebElement that we want to check has a particular class
     * @param cssClass
     *            The CSS class we want to check in the WebElement
     ...
     * 
     * @param bySelector
     *            The by selector for the element we're checking for
     * @param timeout
     ...
     * 
     * @param bySelector
     *            The by selector for the element we're checking is hidden
     * @param timeout
     *            The amount of time to wait in milliseconds
     ...
     * The property value will only be updated in memory, the contents of the testConfig.properties file will not be
     * modified.
     * 
     * @param Properties
     *            [object], propertyname [String], propertyValue[String]
     * @return boolean
     * @throws Exception
     *             Usage : setPropertyValue(properties, "sdp.applicationType", "IB")
     */
    public static boolean setPropertyValue(Properties properties, String propertyName, String propertyValue)
            throws Exception {
     ...
     * 
     * @param Properties
     *            [object], firstPropertyname [String], firstPropertyValue[String], secondPropertyname [String],
     *            secondPropertyValue[String]
     * @return boolean
     * @throws Exception
     *             Usage : setPropertyValue(properties, "sdp.applicationType", "IB",
     *             "firefox.assumeUntrustedCertificateIssuer", "true")
     */
    public static boolean setPropertyValue(Properties properties, String firstPropertyName, String firstPropertyValue,
            String secondPropertyName, String secondPropertyValue) throws Exception {
        boolean setValue = true;
        String PROP_FILE = null;
        String env_testConfig = System.getProperty("testConfigFile");
        String testRoot = System.getProperty("user.dir");
     ...
     * for example if we want to check if a date list from NHP is with in range of custom dates. This Takes in input as
     * List of string
     ...
     * @param driver
     * @param n
     *            :- how much time u want to wait
     * @param ele
     *            :- for which element u want to wait
     */
     ...
     * @param driver
     * @param frames
     *            list of frames (specified in order from parent first to deepest child)
     */
    ...
    public boolean checkCcdType() throws InterruptedException {
        ...
        try {
            ...
            log("###this is a consolidated Ccd." + shareWithDoctorPresent);
            return shareWithDoctorPresent;
        } catch (NoSuchElementException e) {
            shareWithDoctorPresent = false;
            log("### this is a non consolidated Ccd.You cannot share with another doctor" + shareWithDoctorPresent);
            return shareWithDoctorPresent;
    ...
    public static String createRandomStreet() {
        IHGUtil.PrintMethodName();
        return RandomStringUtils.randomNumeric(3) + " " + RandomStringUtils.randomAlphabetic(10) + " "
     ...
     * 
     * @param Xpath
     *            of the table,List of case search criteria
     * @return Row number where the case matching with the search criteria is present
     */
    public static List<Object> searchResultTable(WebDriver pDriver, String pTableXpath,
            ArrayList<String> pMyArr_expected) {
        int i = 0;
        int rowNumber = 0;
        boolean flag = false;
    ...
    /**
     * Description: This method searches for the appropriate case in the case table based on the filtration criteria (a
     * substring)
     * 
     * @param Xpath
     *            of the table,List of case search criteria
     ...
     */
    public static List<Object> searchResultsSubstring(WebDriver pDriver, String pTableXpath,
            ArrayList<String> pMyArr_expected) {
        int i = 0;
        int rowNumber = 0;
        boolean flag = false;
    ...
    public boolean isFoundBasedOnCssSelector(final String cssPath, int timeOutInSeconds) throws InterruptedException {
     ...
     * 
     * @param element
     *            WebElement that will be disappearing
     * @param periodInMilliseconds
     *            determines how long is one waiting cycle
     * @param maxWaitingTimeInSeconds
     *            maximal waiting time in seconds
     * @throws InterruptedException,
     *             TimeoutException
     */
    public <U> void waitForElementToDisappear(U element, long periodInMilliseconds, long maxWaitingTimeInSeconds)
    ...
    public static void waitForElementByClassAndText(WebDriver driver, final String classToFind, final String textToFind,
            int secondsToWait) {
    ...
    public static void waitForElementByClassAndValue(WebDriver driver, final String classToFind,
            final String valueToFind, int secondsToWait) {
        WebDriverWait wdw = new WebDriverWait(driver, secondsToWait);
        ExpectedCondition<Boolean> condition = new ExpectedCondition<Boolean>() {
            @Override
            public Boolean apply(WebDriver d) {
    ...
    /**
     * @brief parses an integer from a positive US locale value string - e.g. $1,590.00 = 159000 ; $1.00 = 100 ; $00.10
     *        = 10
     * @param input
     * @return
     */
    ...
    /**
     * @brief creates a US locale formatted string from input integer, last two digits for cents - e.g. $1,590.00 =
     *        159000 ; $1.00 = 100 ; $00.10 = 10
     * @param input
     * @return
     */
    public static String formatNumber(int input) {
        if (input < 0)
            throw new IllegalArgumentException("Only formats positive integers, insert - as necessary");
        if (input < 10)
            return "$0.0" + input;
        if (input < 100)
            return "$0." + input;
        ...
        String dollars = NumberFormat.getNumberInstance(Locale.US)
                .format(Integer.parseInt(tmp.substring(0, tmp.length() - 2)));
     ...
     */
    public boolean updateAndValidateWebElements(Map<WebElement, String> map) {
