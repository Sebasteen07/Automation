...
public class TestProperties {
    ...
    static {
        ...
        if (propertiesFile != null) {
            TestPropertiesLoader loader = new TestPropertiesLoader(propertiesFile, properties);
            loader.loadProperties();
        } else {
     ...
     * </ol>
     *
     * <p>If both values are null then returns null.</p>
     *
     * @param  name  the name of the property
     *
     * @return  the property value
    ...
    /**
     * Fetch a required property. No defaults obviously, this will throw {@link ConfigError} exception when the property
     * cannot be loaded from system properties or the internal test.properties collection.
     *
