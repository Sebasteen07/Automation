...
public class VirtualCardSwiperPage extends BasePageObject {
     ...
     * @throws Exception
     */
    public void addCreditCardInfo(String ccName, String ccNum, String cardType, String expMonth, String expYear,
            String amt, String cvv, String zip, String PAccount, String PName, String comment) {
        IHGUtil.PrintMethodName();
        // Thread.sleep(4000);
     ...
     */
    public void addCreditCardInfo(String ccName, String ccNum, String cardType, String expMonth, String expYear,
            String amt, String cvv, String zip, String PAccount, String PName, String comment, String location) {
        IHGUtil.PrintMethodName();
        driver.switchTo().frame("iframe");
    ...
    public void addCreditCardMandatoryInfo(String ccName, String ccNum, String cardType, String expMonth,
            String expYear, String amt, String zip, String swipe) {
        IHGUtil.PrintMethodName();
        // Thread.sleep(4000);
