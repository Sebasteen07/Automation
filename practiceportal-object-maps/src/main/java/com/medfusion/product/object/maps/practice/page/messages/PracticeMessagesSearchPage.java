...
public class PracticeMessagesSearchPage extends BasePageObject {
    ...
    /**
     * Searches for all messages given the parameters supplied.
     * Call retrieveMessage after searching to find a specific message.
     * 
     * @param serviceType
     *            use the PracticeMessageServiceType to declare
     * @param firstNameText
     *            the first name of the patient
     * @param lastNameText
     *            the last name of the patient
     * @param subjectText
     *            the subject to search against
     * @param statusText
     *            the visible status in the select box of the message
     * @throws InterruptedException
     */
    private void executeSearch(String serviceType, String firstNameText, String lastNameText, String subjectText,
     ...
     * 
     * @param subjectText
     *            unique subject text to identify the message
    ...
    public PracticeMessagePage retrieveMessage(String subjectText) throws InterruptedException {
        ...
        for (WebElement message : messageList) {
            ...
            Log4jUtil.log(" Found Practice Vov Message with subject: " + message.getText()
                    + ", Needed Message with subject: " + subjectText);
            String msg = message.getText().trim();
            if (msg.endsWith(subjectText)) {
                driver.findElement(By.xpath(
                        ".//*[@id='MfAjaxFallbackDefaultDataTable']/tbody".concat("/tr[" + count + "]/td[1]/span/a")))
                        .click();
                break;
            }
            count++;
