...
public class ApptRequestDetailStep1Page extends BasePageObject {
     ...
     * 
     * @param entity
     *            use one of the other 'choose' helper methods or build your own ApptRequestEntity
     */
    ...
    public ApptRequestDetailStep2Page chooseApproveAndSubmit() {
        ...
        ApptRequestEntity entity = new ApptRequestEntity().setProcessOption(ApptRequestProcessOption.APPROVE)
                .setApptDate("01/01/2020").setSubject("Approved").setBody("This is a response from the Practice")
                .setNoReply(false);
