...
Feature: Test fuctionality of Appointment precheck
  ...
  Scenario: verify notification count for filteration cases where filter is applied for location L1/L2 and later filter is removed and notification count and entry gets updated
