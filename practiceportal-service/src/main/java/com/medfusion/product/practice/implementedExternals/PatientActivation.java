...
public class PatientActivation implements IPatientActivation {
    ...
    public PatientInfo activatePatient(WebDriver driver, PropertyFileLoader testData, String mail)
        ...
        return patientActivationSearchTest.PatientActivation(driver, practiceTestData, mail, testData.getDoctorLogin(),
                testData.getDoctorPassword(), testData.getPortalUrl(), patInfo);
    ...
    public PatientInfo editPatientRSDKExternalID(WebDriver driver, PropertyFileLoader testData, PatientInfo patientInfo)
        ...
        PatientDashboardPage pPatientDashboardPage = pPatientSearchPage.clickOnPatient(patientInfo.firstName,
        ...
        String memberId = driver.findElement(By.xpath("//form[@name = 'edituserinfo']/table/tbody/tr[5]/td[2]"))
                .getText();
