...
public class PatientActivationSearchTest extends BaseTestNGWebDriver {
	...
	public String PatientActivation(WebDriver driver, PracticeTestData practiceTestData, String email, String doctorLogin, String doctorPassword, String url)
	...
	public PatientInfo PatientActivation(WebDriver driver, PracticeTestData practiceTestData, String email, String doctorLogin, String doctorPassword, String url,
			PatientInfo patInfo) throws InterruptedException {
	...
	public String getPatientActivationLink(WebDriver driver, PracticeTestData practiceTestData, String email, String doctorLogin, String doctorPassword,
	...
	public String getPatientActivationLink(WebDriver driver, PracticeTestData practiceTestData, String email, PropertyFileLoader testData) throws Exception {
		return getPatientActivationLink(driver, practiceTestData, email, testData.getDoctorLogin(), testData.getDoctorPassword(), testData.getPortalUrl());
	}
