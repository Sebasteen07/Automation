...
locals {
  valid_workspaces = {
    ...
    prod-mu2-accessibility               = "prod-mu2-accessibility"
    prod-mu2-regression                  = "prod-mu2-regression"
    prod-mu2-acceptance                  = "prod-mu2-acceptance"
    ...
    prod-pss-acceptance                  = "prod-pss-acceptance"
    ...
    prod-p2p-directmessage               = "prod-p2p-directmessage"
    prod-rcm-acceptance                  = "prod-rcm-acceptance"
    ...
    qa-automation-api                    = "qa-automation-api"
    qa-automation-appointment-ui         = "qa-automation-appointment-ui"
  }
