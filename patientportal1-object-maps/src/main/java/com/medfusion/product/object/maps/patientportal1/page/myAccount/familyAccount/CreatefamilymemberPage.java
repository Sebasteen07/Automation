...
public class CreatefamilymemberPage extends BasePageObject {
    ...
    public MyPatientPage createFamilyMember(String firstName, String LastName, String dob_year, String dob_month,
            String dob_Day, String relationWithPatient, String SSN) {
        IHGUtil.PrintMethodName();
