...
public class CreatefamilymemberPage extends BasePageObject {
	...
	public MyPatientPage createFamilyMember(String firstName, String LastName, String dob_year, String dob_month, String dob_Day, String relationWithPatient,
			String SSN) {
		IHGUtil.PrintMethodName();
	...
	public MyPatientPage Verifymember() throws AWTException, InterruptedException {
		...
		PortalUtil.setPortalFrame(driver);
		/*
		 * String str=conformationmessage.getText(); log("+++++Conformation Message is: "+str);
		 */
		...
		/*
		 * Robot robot=new Robot(); robot.keyPress(KeyEvent.VK_ENTER); robot.keyRelease(KeyEvent.VK_ENTER); IHGUtil.waitForElement(driver, 10, conformationmessage);
		 */
