...
public class MessagePage extends BasePageObject {
    ...
    String[] myDirectResponsesPortal = { "ihg!!!qa@service.directaddress.net is invalid. Please correct the format.",
    ...
    public boolean isSubjectLocated(String subject) throws InterruptedException {
        ...
        WebElement messageHeader = wait.until(
                ExpectedConditions.visibilityOfElementLocated((By.xpath("//*[contains(text(),'" + subject + "')]"))));
    ...
    public String readSigCode(String sigCodeMeaning) throws InterruptedException {
        ...
        log("Searching: SigCode Meaning is:" + sigCodeMeaning + ", and Actual SigCode Meaning is:"
                + sigCodeInstructions.getText().toString());
