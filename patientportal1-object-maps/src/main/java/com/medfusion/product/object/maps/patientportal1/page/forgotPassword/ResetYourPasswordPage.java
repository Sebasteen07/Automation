...
public class ResetYourPasswordPage extends BasePageObject {
    ...
    public ActivatePasswordChangePage resetYourPasswordPage(String userId, String securityAnswer, String password)
            throws Exception {
    ...
    private String checkYourMailinator(String email) throws Exception {
        ...
        String url = mail.catchNewMessage(mailAddress[0], emailSubject, PortalConstants.TextInForgotPasswordEmailLink,
                20);
    ...
    public SecretAnswerDoesntMatchPage sendBadAnswerTwice(String userId, String securityAnswer) {
        ...
        assertTrue(feedBackError.getText()
                .contains("Your answer to the security question doesn't match our records. Please try again"));
