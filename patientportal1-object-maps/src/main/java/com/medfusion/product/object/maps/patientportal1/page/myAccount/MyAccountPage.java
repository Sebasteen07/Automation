...
public class MyAccountPage extends BasePageObject {
    ...
    public void assertMobilePhoneNumber(String phoneNumber) {
        ...
        Assert.assertEquals(portalMobileNumber.replaceAll("\\D", ""), phoneNumber,
                "The Mobile Phone number is not updated in PHR ##### ");
    }
    ...
    public void assertHomePhoneNumber(String phoneNumber) {
        ...
        Assert.assertEquals(portalHomeNumber.replaceAll("\\D", ""), phoneNumber,
                "The Home Phone number is not updated in PHR ##### ");
    }
    ...
    public void submit() {
        btnSubmit.click();
        Assert.assertTrue(driver.getPageSource().contains("Your Profile has been updated"),
                "New values didnt get updated");
    }
}
