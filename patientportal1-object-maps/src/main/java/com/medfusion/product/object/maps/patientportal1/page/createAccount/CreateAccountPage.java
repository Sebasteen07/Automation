...
public class CreateAccountPage extends BasePageObject {
    ...
    public MyPatientPage createAccountPage(String patientFirstName, String patientLastName, String email,
            String patientPhoneNumber, String patientZip, String address, String password, String Question,
            String answer, String state, String city) {
        ...
        /*
         * Note that after changes, selecting a provider is currently disabled on testpractices across all environments
         * by default
         * chooseProvider();
         */
     ...
     * @return
     */
    public CreateAccountExistingUserPage tryCreateExistingUser(String patientFirstName, String patientLastName,
            String patientZip, String patientSSN, String email, String bMonth, String bDay, String bYear) {
     ...
     * @return
     */
    public CreateAccountHealthKeyPage tryCreateExistingUserDiffPrac(String patientFirstName, String patientLastName,
            String patientZip, String patientSSN, String email, String bMonth, String bDay, String bYear) {
    ...
    public void chooseSecretQuestion(String pProvider) {
        ...
        List<WebElement> list = driver
                .findElements(By.xpath("//select[@name='editLoginInfo:border:editForm:inputs:6:input:input']/option"));
    ...
    public MyPatientPage fillInShortPatientCreation(String sPatientFirstName, String sPatientLastName, String sBirthDay,
            String sZipCode, String sSSN, String sEmail) {
