package com.medfusion.product.object.maps.patientportal1.page.myAccount.wallet;
...
public class WalletPage extends BasePageObject {
    ...
    public void verifyCreditCardDetails(String sCardholderName, String sCreditCardType, String smonth, String sYear)
            throws Exception {
        IHGUtil.PrintMethodName();
    ...
    public void addCreditCardDetails(String sCardholderName, String sCreditCardType, String sCreditCardNumber,
            String smonth, String sYear, String sZipcode) throws Exception {
        IHGUtil.PrintMethodName();
        PortalUtil.setPortalFrame(driver);
