...
public class VirtualOfficeVisitHistoryPage extends BasePageObject {
     ...
     * 
     * @param sentDate
     *            should be a date taken right before the Virtual Office Visit is submitted
    ...
    public VirtualOfficeVisitHistoryDetailPage viewVirtualOfficeVisitHistoryDetails(Date sentDate) throws Exception {
         ...
         * log("Received Date: " + item.getText() + ", Sent Date: " + formatter.format(sentDate) +
         * ", ReceivedDateOlder?: " + sentDate.compareTo(receivedDate));
