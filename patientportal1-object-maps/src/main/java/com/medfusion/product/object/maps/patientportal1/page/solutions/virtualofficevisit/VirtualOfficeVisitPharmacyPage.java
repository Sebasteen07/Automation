...
public class VirtualOfficeVisitPharmacyPage extends BasePageObject {
	...
	/**
	 * Will select the supplied pharmacy and click continue. If there is no pharmacy supplied the last item in the list is selected.
	 * 
	...
	/**
	 * A practice may turn on a waiver of liability that must be consented. When this occurs, the button changes from 'Continue' to 'Agree and Continue'. So this
	 * method will look for 'Continue' button, and if it doesn't exist click on the 'Agree and Continue' button.
	 */
