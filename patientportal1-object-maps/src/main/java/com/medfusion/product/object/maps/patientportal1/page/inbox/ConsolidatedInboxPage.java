...
public class ConsolidatedInboxPage extends BasePageObject {
     ...
     * @throws InterruptedException
     */
    public ConsolidatedInboxMessage clickMessageLinkOpenMessageInInbox(String uniqueSubString)
            throws InterruptedException {
        ...
        try {
            ...
            if (!list.isEmpty()) {
                ...
                driver.findElement(By.xpath("//table[@id='MfAjaxFallbackDefaultDataTable']/tbody"
                        .concat("/tr[" + Integer.parseInt(list.get(0).toString()) + "]/td[3]"))).click();
            } else {
