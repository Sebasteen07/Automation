...
public class InsurancePage extends BasePageObject {
    ...
    // Class and value of the Submit Insurance button - present either after clicking Add Insurance or by default, when
    // no Insurances are defined for patient
    ...
    public void allInsuranceDetails(String InsuranceName, String Insurancetype, String Relation,
            List<String> insurancelist) throws InterruptedException {
    ...
    public void waitForSubmitInsuranceButton() {
        ...
        try {
            IHGUtil.waitForElementByClassAndValue(driver, submitInsuranceButtonClass, submitInsuranceButtonValue,
                    waitingTime);
        } catch (Exception e) {
