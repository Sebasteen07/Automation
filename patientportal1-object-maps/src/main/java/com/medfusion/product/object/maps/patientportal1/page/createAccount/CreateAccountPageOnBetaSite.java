...
public class CreateAccountPageOnBetaSite extends BasePageObject {
    ...
    public CreateAccountPasswordPage createAccount(String patientFirstName, String patientLastName, String email,
            String patientEmail, String patientPhoneNumber, String patientPhoneType, String patientDob_Month,
            String patientDob_Day, String patientDob_Year, String patientZip, String patientSSN) {
