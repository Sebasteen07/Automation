...
public class MakePaymentPage extends BasePageObject {
    ...
    public void setMakePaymentFields(String accountNumber) {
        ...
        // This is temporary fix for Dev3 and need to be made generic after element value change is available in Demo
        // and Production after 15.1 deployment
    ...
    public String readConfirmationNumber() {
        ...
        return confirmationNumber.substring(
                confirmationNumber.indexOf("confirmation number is ") + "confirmation number is ".length(),
