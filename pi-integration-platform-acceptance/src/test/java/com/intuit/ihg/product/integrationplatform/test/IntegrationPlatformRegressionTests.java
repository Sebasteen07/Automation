...
public class IntegrationPlatformRegressionTests extends BaseTestNGWebDriver {
	...
	public void testAMDCSecureMessages() throws Exception {
		...
		Thread.sleep(4000);
		// MedicalRecordSummariesPage MedicalRecordSummariesPageObject =
		// homePage.clickOnMedicalRecordSummaries(driver);
		...
		/*
		 * log("Step 20: Verify name, from and catagory type"); String attachmentData =
		 * MedicalRecordSummariesPageObject.getMessageAttachmentData();
		 * log("attachment details " +
		 * MedicalRecordSummariesPageObject.getMessageAttachmentData());
		 * Assert.assertTrue(attachmentData.contains(testData.fileName),
		 * "file name not found");
		...
		// Assert.assertTrue(attachmentData.contains(testData.fileName), "file name not
		// found");
		Thread.sleep(5000);
		MedicalRecordSummariesPageObject.downloadSecureMessageAttachment();
